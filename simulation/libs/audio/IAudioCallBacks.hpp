...
class IGetDevicesCb : public telux::common::ICommandCallback {
 public:
    virtual void onGetDevicesResult(telux::common::ErrorCode ec,
        std::vector<DeviceType> deviceTypes, std::vector<DeviceDirection> deviceDirections,
        int cmdId)
        = 0;
};
...
class IGetStreamsCb : public telux::common::ICommandCallback {
 public:
    virtual void onGetStreamsResult(
...
class IGetCalInitStatusCb : public telux::common::ICommandCallback {
 public:
    virtual void onGetCalInitStatusResult(
...
class ICreateStreamCb : public telux::common::ICommandCallback {
 public:
    virtual void onCreateStreamResult(
...
class IDeleteStreamCb : public telux::common::ICommandCallback {
 public:
    virtual void onDeleteStreamResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId)
        = 0;
};

class IStartStreamCb : public telux::common::ICommandCallback {
 public:
    virtual void onStreamStartResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};

class IStopStreamCb : public telux::common::ICommandCallback {
 public:
    virtual void onStreamStopResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};

class IToneCb : public telux::common::ICommandCallback {
 public:
    virtual void onToneStartResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;

    virtual void onToneStopResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};
...
class IWriteCb : public telux::common::ICommandCallback {
 public:
    virtual void onWriteResult(telux::common::ErrorCode ec, uint32_t streamId,
        uint32_t bytesWritten, AudioUserData *userData)
        = 0;
};
...
class IReadCb : public telux::common::ICommandCallback {
 public:
    virtual void onReadResult(telux::common::ErrorCode ec, uint32_t streamId,
        uint32_t numBytesActuallyRead, AudioUserData *userData)
        = 0;
};

class IFlushCb : public telux::common::ICommandCallback {
 public:
    virtual void onFlushResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};

class IDrainCb : public telux::common::ICommandCallback {
 public:
    virtual void onDrainResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};

class ISetGetDeviceCb : public telux::common::ICommandCallback {
 public:
    virtual void onSetDeviceResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;

    virtual void onGetDeviceResult(
...
class ISetGetVolumeCb : public telux::common::ICommandCallback {
 public:
    virtual void onSetVolumeResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
...
class ISetGetMuteCb : public telux::common::ICommandCallback {
 public:
    virtual void onSetMuteResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
...
class IDTMFCb : public telux::common::ICommandCallback {
 public:
    virtual void onPlayDtmfResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;

    virtual void onStopDtmfResult(telux::common::ErrorCode ec, uint32_t streamId, int cmdId) = 0;
};

class ITranscodeCreateCb : public telux::common::ICommandCallback {
 public:
    virtual void onCreateTranscoderResult(
...
class ITranscodeDeleteCb : public telux::common::ICommandCallback {
 public:
    virtual void onDeleteTranscoderResult(
        telux::common::ErrorCode ec, uint32_t inStreamId, uint32_t outStreamId, int cmdId)
        = 0;
};

class IIndicationCb : public telux::common::ICommandCallback {
 public:
    virtual void onIndicationRegisterResult(
        telux::common::ErrorCode ec, uint32_t streamId, int cmdId)
        = 0;

    virtual void onIndicationDeRegisterResult(
        telux::common::ErrorCode ec, uint32_t streamId, int cmdId)
        = 0;
};
