...
static const char *kStr[] = {  // MUST be in the same order as JsonKeys enum.
    "totalTx", "totalRx", "totalRSUs", "totalRVs", "rxFails", "decodeFails", "securityFails",
    "mbdAlerts", "txBSMs", "txSignedBSMs", "rxBSMs", "rxSignedBSMs", "monitorRate", "timeframe",
    "timestamp", "jsonVersion", "qitsVersion", "telsdkVersion", "qMonVersion", "blob", "close"};
