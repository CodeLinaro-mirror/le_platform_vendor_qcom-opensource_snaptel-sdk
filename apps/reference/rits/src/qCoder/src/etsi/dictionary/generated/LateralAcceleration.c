...
static asn_TYPE_member_t asn_MBR_LateralAcceleration_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct LateralAcceleration, lateralAccelerationValue),
        ...
        &asn_DEF_LateralAccelerationValue, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "lateralAccelerationValue"},
    {ATF_NOFLAGS, 0, offsetof(struct LateralAcceleration, lateralAccelerationConfidence),
        ...
        0, /* No PER visible constraints */
        0, "lateralAccelerationConfidence"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_LateralAcceleration_specs_1 = {
    sizeof(struct LateralAcceleration), offsetof(struct LateralAcceleration, _asn_ctx),
    asn_MAP_LateralAcceleration_tag2el_1, 2, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_LateralAcceleration = {
    "LateralAcceleration", "LateralAcceleration", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_LateralAcceleration_tags_1)
        / sizeof(asn_DEF_LateralAcceleration_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_LateralAcceleration_1, 2, /* Elements count */
