...
class EventManager : public ITcuActivityListener,
 ...
 public:
    ...
    void registerListener(
        weak_ptr<IEventListener> eventListener, TriggerType triggerType = TriggerType::UNKNOWN);
    void updateEventStatus(
        shared_ptr<Event> event, bool processed, bool succeed, EventStatus status);
