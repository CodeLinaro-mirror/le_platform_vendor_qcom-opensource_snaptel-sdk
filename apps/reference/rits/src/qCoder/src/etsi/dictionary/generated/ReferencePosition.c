...
static asn_TYPE_member_t asn_MBR_ReferencePosition_1[] = {
    ...
    {ATF_NOFLAGS, 0, offsetof(struct ReferencePosition, positionConfidenceEllipse),
        ...
        &asn_DEF_PosConfidenceEllipse, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "positionConfidenceEllipse"},
    {ATF_NOFLAGS, 0, offsetof(struct ReferencePosition, altitude),
        (ASN_TAG_CLASS_CONTEXT | (3 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_Altitude, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "altitude"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_ReferencePosition_specs_1 = {
    sizeof(struct ReferencePosition), offsetof(struct ReferencePosition, _asn_ctx),
    asn_MAP_ReferencePosition_tag2el_1, 4, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ReferencePosition = {
    "ReferencePosition", "ReferencePosition", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_ReferencePosition_tags_1) / sizeof(asn_DEF_ReferencePosition_tags_1[0]), /* 1 */
    asn_DEF_ReferencePosition_tags_1, /* Same as above */
    sizeof(asn_DEF_ReferencePosition_tags_1) / sizeof(asn_DEF_ReferencePosition_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_ReferencePosition_1, 4, /* Elements count */
