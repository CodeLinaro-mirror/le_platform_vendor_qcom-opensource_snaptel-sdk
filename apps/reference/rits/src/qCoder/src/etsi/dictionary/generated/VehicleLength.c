...
static asn_TYPE_member_t asn_MBR_VehicleLength_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct VehicleLength, vehicleLengthValue),
        ...
        &asn_DEF_VehicleLengthValue, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vehicleLengthValue"},
    {ATF_NOFLAGS, 0, offsetof(struct VehicleLength, vehicleLengthConfidenceIndication),
        ...
        0, /* No PER visible constraints */
        0, "vehicleLengthConfidenceIndication"},
};
static const ber_tlv_tag_t asn_DEF_VehicleLength_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
static asn_SEQUENCE_specifics_t asn_SPC_VehicleLength_specs_1 = {
    sizeof(struct VehicleLength), offsetof(struct VehicleLength, _asn_ctx),
    asn_MAP_VehicleLength_tag2el_1, 2, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_VehicleLength = {
    "VehicleLength", "VehicleLength", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_VehicleLength_tags_1) / sizeof(asn_DEF_VehicleLength_tags_1[0]), /* 1 */
    asn_DEF_VehicleLength_tags_1, /* Same as above */
    sizeof(asn_DEF_VehicleLength_tags_1) / sizeof(asn_DEF_VehicleLength_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_VehicleLength_1, 2, /* Elements count */
