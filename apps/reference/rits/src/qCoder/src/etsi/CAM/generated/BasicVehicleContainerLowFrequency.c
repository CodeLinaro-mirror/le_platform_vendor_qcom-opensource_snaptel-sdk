...
static asn_TYPE_member_t asn_MBR_BasicVehicleContainerLowFrequency_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerLowFrequency, vehicleRole),
        ...
        &asn_DEF_VehicleRole, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vehicleRole"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerLowFrequency, exteriorLights),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_ExteriorLights, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "exteriorLights"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerLowFrequency, pathHistory),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_PathHistory, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "pathHistory"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_BasicVehicleContainerLowFrequency_specs_1 = {
    ...
    asn_MAP_BasicVehicleContainerLowFrequency_tag2el_1, 3, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_BasicVehicleContainerLowFrequency = {
    "BasicVehicleContainerLowFrequency", "BasicVehicleContainerLowFrequency", SEQUENCE_free,
    ...
    sizeof(asn_DEF_BasicVehicleContainerLowFrequency_tags_1)
        / sizeof(asn_DEF_BasicVehicleContainerLowFrequency_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_BasicVehicleContainerLowFrequency_1, 3, /* Elements count */
