...
static asn_TYPE_member_t asn_MBR_RoadWorksContainerExtended_1[] = {
    {ATF_POINTER, 9, offsetof(struct RoadWorksContainerExtended, lightBarSirenInUse),
        ...
        &asn_DEF_LightBarSirenInUse, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "lightBarSirenInUse"},
    {ATF_POINTER, 8, offsetof(struct RoadWorksContainerExtended, closedLanes),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_ClosedLanes, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "closedLanes"},
    {ATF_POINTER, 7, offsetof(struct RoadWorksContainerExtended, restriction),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_RestrictedTypes, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "restriction"},
    {ATF_POINTER, 6, offsetof(struct RoadWorksContainerExtended, speedLimit),
        ...
        &asn_DEF_SpeedLimit, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "speedLimit"},
    {ATF_POINTER, 5, offsetof(struct RoadWorksContainerExtended, incidentIndication),
        ...
        &asn_DEF_CauseCode, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "incidentIndication"},
    {ATF_POINTER, 4, offsetof(struct RoadWorksContainerExtended, recommendedPath),
        ...
        &asn_DEF_ItineraryPath, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "recommendedPath"},
    {ATF_POINTER, 3, offsetof(struct RoadWorksContainerExtended, startingPointSpeedLimit),
        ...
        &asn_DEF_DeltaReferencePosition, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "startingPointSpeedLimit"},
    {ATF_POINTER, 2, offsetof(struct RoadWorksContainerExtended, trafficFlowRule),
        ...
        &asn_DEF_TrafficRule, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "trafficFlowRule"},
    {ATF_POINTER, 1, offsetof(struct RoadWorksContainerExtended, referenceDenms),
        ...
        &asn_DEF_ReferenceDenms, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "referenceDenms"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_RoadWorksContainerExtended_specs_1 = {
    ...
    asn_MAP_RoadWorksContainerExtended_tag2el_1, 9, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_RoadWorksContainerExtended = {
    "RoadWorksContainerExtended", "RoadWorksContainerExtended", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_RoadWorksContainerExtended_tags_1)
        / sizeof(asn_DEF_RoadWorksContainerExtended_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_RoadWorksContainerExtended_1, 9, /* Elements count */
