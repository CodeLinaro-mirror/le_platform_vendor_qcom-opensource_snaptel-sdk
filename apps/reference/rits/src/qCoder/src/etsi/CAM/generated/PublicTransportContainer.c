...
static asn_TYPE_member_t asn_MBR_PublicTransportContainer_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct PublicTransportContainer, embarkationStatus),
        ...
        &asn_DEF_EmbarkationStatus, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "embarkationStatus"},
    {ATF_POINTER, 1, offsetof(struct PublicTransportContainer, ptActivation),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_PtActivation, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "ptActivation"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_PublicTransportContainer_specs_1 = {
    sizeof(struct PublicTransportContainer), offsetof(struct PublicTransportContainer, _asn_ctx),
    asn_MAP_PublicTransportContainer_tag2el_1, 2, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_PublicTransportContainer = {
    "PublicTransportContainer", "PublicTransportContainer", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_PublicTransportContainer_tags_1)
        / sizeof(asn_DEF_PublicTransportContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_PublicTransportContainer_1, 2, /* Elements count */
