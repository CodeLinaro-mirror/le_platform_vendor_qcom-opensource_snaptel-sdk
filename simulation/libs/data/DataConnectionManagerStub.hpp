...
class DataConnectionManagerStub : public IDataConnectionManager,
 ...
 public:
    ...
    telux::common::Status setRoamingMode(bool enable, uint8_t profileId,
        OperationType operationType, telux::common::ResponseCallback callback = nullptr) override;
    ...
    telux::common::Status requestDataCallList(
        OperationType type, DataCallListResponseCb callback) override;

    telux::common::Status requestThrottledApnInfo(ThrottleInfoCb callback) override;

    telux::common::Status registerListener(
        std::weak_ptr<IDataConnectionListener> listener) override;
