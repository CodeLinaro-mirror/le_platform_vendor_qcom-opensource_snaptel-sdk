...
static asn_TYPE_member_t asn_MBR_LowFrequencyContainer_1[] = {
    {ATF_NOFLAGS, 0,
        offsetof(struct LowFrequencyContainer, choice.basicVehicleContainerLowFrequency),
...
static asn_CHOICE_specifics_t asn_SPC_LowFrequencyContainer_specs_1 = {
    sizeof(struct LowFrequencyContainer), offsetof(struct LowFrequencyContainer, _asn_ctx),
    offsetof(struct LowFrequencyContainer, present),
    sizeof(((struct LowFrequencyContainer *)0)->present), asn_MAP_LowFrequencyContainer_tag2el_1,
    1, /* Count of tags in the map */
    0, 1 /* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_LowFrequencyContainer = {
    "LowFrequencyContainer", "LowFrequencyContainer", CHOICE_free, CHOICE_print, CHOICE_constraint,
    ...
    0, /* No tags (pointer) */
    0, /* No tags (count) */
    &asn_PER_type_LowFrequencyContainer_constr_1, asn_MBR_LowFrequencyContainer_1,
    1, /* Elements count */
