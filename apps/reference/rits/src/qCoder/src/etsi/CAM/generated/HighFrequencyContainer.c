...
static asn_TYPE_member_t asn_MBR_HighFrequencyContainer_1[] = {
    {ATF_NOFLAGS, 0,
        offsetof(struct HighFrequencyContainer, choice.basicVehicleContainerHighFrequency),
    ...
    {ATF_NOFLAGS, 0, offsetof(struct HighFrequencyContainer, choice.rsuContainerHighFrequency),
        ...
        &asn_DEF_RSUContainerHighFrequency, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "rsuContainerHighFrequency"},
};
...
static asn_CHOICE_specifics_t asn_SPC_HighFrequencyContainer_specs_1 = {
    sizeof(struct HighFrequencyContainer), offsetof(struct HighFrequencyContainer, _asn_ctx),
    offsetof(struct HighFrequencyContainer, present),
    sizeof(((struct HighFrequencyContainer *)0)->present), asn_MAP_HighFrequencyContainer_tag2el_1,
    2, /* Count of tags in the map */
    0, 2 /* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_HighFrequencyContainer = {
    "HighFrequencyContainer", "HighFrequencyContainer", CHOICE_free, CHOICE_print,
    ...
    0, /* No tags (pointer) */
    0, /* No tags (count) */
    &asn_PER_type_HighFrequencyContainer_constr_1, asn_MBR_HighFrequencyContainer_1,
    2, /* Elements count */
