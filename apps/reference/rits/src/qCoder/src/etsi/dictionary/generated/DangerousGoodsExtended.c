...
static int memb_unNumber_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int memb_emergencyActionCode_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
    asn_app_constraint_failed_f *ctfailcb, void *app_key) {
    const IA5String_t *st = (const IA5String_t *)sptr;
    size_t size;
    ...
    if ((size >= 1 && size <= 24) && !check_permitted_alphabet_7(st)) {
        /* Constraint check succeeded */
        return 0;
    } else {
        ASN__CTFAIL(
...
static int memb_phoneNumber_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
    asn_app_constraint_failed_f *ctfailcb, void *app_key) {
    const IA5String_t *st = (const IA5String_t *)sptr;
    size_t size;
    ...
    if ((size >= 1 && size <= 24) && !check_permitted_alphabet_8(st)) {
        /* Constraint check succeeded */
        return 0;
    } else {
        ASN__CTFAIL(
...
static int memb_companyName_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
    asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_per_constraints_t asn_PER_memb_unNumber_constr_3 GCC_NOTUSED = {
    {APC_CONSTRAINED, 14, 14, 0, 9999} /* (0..9999) */, {APC_UNCONSTRAINED, -1, -1, 0, 0}, 0,
    0 /* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_emergencyActionCode_constr_7 GCC_NOTUSED = {
    {APC_CONSTRAINED, 7, 7, 0, 127} /* (0..127) */,
    {APC_CONSTRAINED, 5, 5, 1, 24} /* (SIZE(1..24)) */, 0, 0 /* No PER character map necessary */
};
...
static asn_TYPE_member_t asn_MBR_DangerousGoodsExtended_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct DangerousGoodsExtended, dangerousGoodsType),
        ...
        &asn_DEF_DangerousGoodsBasic, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "dangerousGoodsType"},
    {ATF_NOFLAGS, 0, offsetof(struct DangerousGoodsExtended, unNumber),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_NativeInteger, memb_unNumber_constraint_1, &asn_PER_memb_unNumber_constr_3, 0,
        "unNumber"},
    ...
    {ATF_POINTER, 3, offsetof(struct DangerousGoodsExtended, emergencyActionCode),
        ...
        &asn_DEF_IA5String, memb_emergencyActionCode_constraint_1,
        &asn_PER_memb_emergencyActionCode_constr_7, 0, "emergencyActionCode"},
    {ATF_POINTER, 2, offsetof(struct DangerousGoodsExtended, phoneNumber),
        ...
        &asn_DEF_IA5String, memb_phoneNumber_constraint_1, &asn_PER_memb_phoneNumber_constr_8, 0,
        "phoneNumber"},
    {ATF_POINTER, 1, offsetof(struct DangerousGoodsExtended, companyName),
        ...
        &asn_DEF_UTF8String, memb_companyName_constraint_1, &asn_PER_memb_companyName_constr_9, 0,
        "companyName"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_DangerousGoodsExtended_specs_1 = {
    sizeof(struct DangerousGoodsExtended), offsetof(struct DangerousGoodsExtended, _asn_ctx),
    asn_MAP_DangerousGoodsExtended_tag2el_1, 8, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_DangerousGoodsExtended = {
    "DangerousGoodsExtended", "DangerousGoodsExtended", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_DangerousGoodsExtended_tags_1)
        / sizeof(asn_DEF_DangerousGoodsExtended_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_DangerousGoodsExtended_1, 8, /* Elements count */
