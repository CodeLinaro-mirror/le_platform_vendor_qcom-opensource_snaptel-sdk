...
static asn_TYPE_member_t asn_MBR_RoadWorksContainerBasic_1[] = {
    {ATF_POINTER, 1, offsetof(struct RoadWorksContainerBasic, roadworksSubCauseCode),
        ...
        &asn_DEF_RoadworksSubCauseCode, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "roadworksSubCauseCode"},
...
static asn_SEQUENCE_specifics_t asn_SPC_RoadWorksContainerBasic_specs_1 = {
    sizeof(struct RoadWorksContainerBasic), offsetof(struct RoadWorksContainerBasic, _asn_ctx),
    asn_MAP_RoadWorksContainerBasic_tag2el_1, 3, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_RoadWorksContainerBasic = {
    "RoadWorksContainerBasic", "RoadWorksContainerBasic", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_RoadWorksContainerBasic_tags_1)
        / sizeof(asn_DEF_RoadWorksContainerBasic_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_RoadWorksContainerBasic_1, 3, /* Elements count */
