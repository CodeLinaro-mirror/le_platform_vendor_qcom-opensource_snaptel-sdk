...
private:
    enum class RetryMode { None, Drop, Fail };

    // Unified worker
    void startUnifiedRetry(RetryMode mode, int phoneId, const std::string &number,
...
public:
 static void makeCallResponse(telux::common::ErrorCode error,
