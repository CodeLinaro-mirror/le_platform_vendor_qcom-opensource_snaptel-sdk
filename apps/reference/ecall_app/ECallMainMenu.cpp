...
bool ECallMainMenu::init() {
    std::shared_ptr<ConsoleAppCommand> ecallAppCommand
        = std::make_shared<ConsoleAppCommand>(ConsoleAppCommand("1", "eCall", {},
            std::bind(&ECallMainMenu::ecallAppMenu, this, std::placeholders::_1)));
    std::shared_ptr<ConsoleAppCommand> aecsCallCommand
        = std::make_shared<ConsoleAppCommand>(ConsoleAppCommand("2", "AECS_Call", {},
