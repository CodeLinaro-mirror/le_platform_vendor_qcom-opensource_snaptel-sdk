...
static asn_TYPE_member_t asn_MBR_VehicleIdentification_1[] = {
    {ATF_POINTER, 2, offsetof(struct VehicleIdentification, wMInumber),
        ...
        &asn_DEF_WMInumber, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "wMInumber"},
    {ATF_POINTER, 1, offsetof(struct VehicleIdentification, vDS),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_VDS, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vDS"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_VehicleIdentification_specs_1 = {
    sizeof(struct VehicleIdentification), offsetof(struct VehicleIdentification, _asn_ctx),
    asn_MAP_VehicleIdentification_tag2el_1, 2, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_VehicleIdentification = {
    "VehicleIdentification", "VehicleIdentification", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_VehicleIdentification_tags_1)
        / sizeof(asn_DEF_VehicleIdentification_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_VehicleIdentification_1, 2, /* Elements count */
