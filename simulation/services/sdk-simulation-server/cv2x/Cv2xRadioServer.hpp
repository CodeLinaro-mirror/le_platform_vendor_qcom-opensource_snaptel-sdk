...
class Cv2xRadioServer final : public cv2xStub::Cv2xRadioService::Service,
 ...
 public:
    ...
    grpc::Status addRxSubscription(ServerContext *context, const cv2xStub::RxSubscription *request,
        cv2xStub::Cv2xCommandReply *res);
    grpc::Status delRxSubscription(ServerContext *context, const cv2xStub::RxSubscription *request,
        cv2xStub::Cv2xCommandReply *res);
    ...
    grpc::Status registerFlow(ServerContext *context, const cv2xStub::FlowInfo *request,
        cv2xStub::Cv2xRadioFlowReply *res);
    grpc::Status deregisterFlow(ServerContext *context, const cv2xStub::FlowInfo *request,
        cv2xStub::Cv2xRadioFlowReply *res);
    grpc::Status updateSrcL2Info(ServerContext *context, const google::protobuf::Empty *request,
        cv2xStub::Cv2xCommandReply *res);
    grpc::Status updateTrustedUEList(ServerContext *context, const google::protobuf::Empty *request,
        cv2xStub::Cv2xCommandReply *res);
    grpc::Status getIfaceNameFromIpType(
        ServerContext *context, const cv2xStub::IpType *request, cv2xStub::IfaceNameReply *res);
    grpc::Status enableTxStatusReport(
        ServerContext *context, const cv2xStub::UintNum *request, cv2xStub::Cv2xCommandReply *res);
    grpc::Status disableTxStatusReport(
        ServerContext *context, const cv2xStub::UintNum *request, cv2xStub::Cv2xCommandReply *res);
    grpc::Status setGlobalIPInfo(ServerContext *context, const google::protobuf::Empty *request,
        ::cv2xStub::Cv2xCommandReply *res);
    ...
    grpc::Status requestDataSessionSettings(ServerContext *context,
        const google::protobuf::Empty *request, ::cv2xStub::Cv2xCommandReply *res);
    grpc::Status injectVehicleSpeed(
        ServerContext *context, const cv2xStub::UintNum *request, cv2xStub::Cv2xCommandReply *res);

 private:
    void onStatusChanged(telux::cv2x::Cv2xStatus status) override;
    inline ::commonStub::Status saveFlowInfo(std::map<uint32_t, cv2xStub::FlowInfo> &flows,
        cv2xStub::FlowInfo &flow, const uint32_t base, const uint32_t max, int32_t &flowId);
    inline ::commonStub::Status removeFlowInfo(
