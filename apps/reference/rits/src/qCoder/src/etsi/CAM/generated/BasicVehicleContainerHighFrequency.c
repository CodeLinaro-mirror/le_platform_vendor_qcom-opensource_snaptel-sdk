...
static asn_TYPE_member_t asn_MBR_BasicVehicleContainerHighFrequency_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, heading),
        ...
        &asn_DEF_Heading, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "heading"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, speed),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_Speed, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "speed"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, driveDirection),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_DriveDirection, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "driveDirection"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, vehicleLength),
        ...
        &asn_DEF_VehicleLength, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vehicleLength"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, vehicleWidth),
        ...
        &asn_DEF_VehicleWidth, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vehicleWidth"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, longitudinalAcceleration),
        ...
        &asn_DEF_LongitudinalAcceleration, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "longitudinalAcceleration"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, curvature),
        ...
        &asn_DEF_Curvature, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "curvature"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, curvatureCalculationMode),
        ...
        &asn_DEF_CurvatureCalculationMode, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "curvatureCalculationMode"},
    {ATF_NOFLAGS, 0, offsetof(struct BasicVehicleContainerHighFrequency, yawRate),
        ...
        &asn_DEF_YawRate, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "yawRate"},
    {ATF_POINTER, 7, offsetof(struct BasicVehicleContainerHighFrequency, accelerationControl),
        ...
        &asn_DEF_AccelerationControl, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "accelerationControl"},
    {ATF_POINTER, 6, offsetof(struct BasicVehicleContainerHighFrequency, lanePosition),
        (ASN_TAG_CLASS_CONTEXT | (10 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_LanePosition, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "lanePosition"},
    {ATF_POINTER, 5, offsetof(struct BasicVehicleContainerHighFrequency, steeringWheelAngle),
        (ASN_TAG_CLASS_CONTEXT | (11 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_SteeringWheelAngle, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "steeringWheelAngle"},
    {ATF_POINTER, 4, offsetof(struct BasicVehicleContainerHighFrequency, lateralAcceleration),
        (ASN_TAG_CLASS_CONTEXT | (12 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_LateralAcceleration, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "lateralAcceleration"},
    {ATF_POINTER, 3, offsetof(struct BasicVehicleContainerHighFrequency, verticalAcceleration),
        (ASN_TAG_CLASS_CONTEXT | (13 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_VerticalAcceleration, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "verticalAcceleration"},
    {ATF_POINTER, 2, offsetof(struct BasicVehicleContainerHighFrequency, performanceClass),
        (ASN_TAG_CLASS_CONTEXT | (14 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_PerformanceClass, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "performanceClass"},
    {ATF_POINTER, 1, offsetof(struct BasicVehicleContainerHighFrequency, cenDsrcTollingZone),
        (ASN_TAG_CLASS_CONTEXT | (15 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_CenDsrcTollingZone, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "cenDsrcTollingZone"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_BasicVehicleContainerHighFrequency_specs_1 = {
    ...
    asn_MAP_BasicVehicleContainerHighFrequency_tag2el_1, 16, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_BasicVehicleContainerHighFrequency = {
    "BasicVehicleContainerHighFrequency", "BasicVehicleContainerHighFrequency", SEQUENCE_free,
    SEQUENCE_print, SEQUENCE_constraint, SEQUENCE_decode_ber, SEQUENCE_encode_der,
    SEQUENCE_decode_xer, SEQUENCE_encode_xer, SEQUENCE_decode_uper, SEQUENCE_encode_uper,
    ...
    sizeof(asn_DEF_BasicVehicleContainerHighFrequency_tags_1)
        / sizeof(asn_DEF_BasicVehicleContainerHighFrequency_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_BasicVehicleContainerHighFrequency_1, 16, /* Elements count */
