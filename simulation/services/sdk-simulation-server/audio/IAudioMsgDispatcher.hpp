...
class IAudioMsgDispatcher {
 ...
 public:
    ...
    virtual void sendGetSupportedStreamTypesResponse(std::shared_ptr<AudioRequest> audioRequest,
        telux::common::ErrorCode ec, std::vector<StreamType> const &streamTypes)
        = 0;
    ...
    virtual void sendDeleteStreamResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendStartResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendStopResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendSetDeviceResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;
    ...
    virtual void sendSetVolumeResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;
    ...
    virtual void sendSetMuteStateResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;
    ...
    virtual void sendStartDtmfResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendStopDtmfResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendStartToneResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendStopToneResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendDrainResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendFlushResponse(
        std::shared_ptr<AudioRequest> audioRequest, telux::common::ErrorCode ec, uint32_t streamId)
        = 0;

    virtual void sendCreateTranscoderResponse(std::shared_ptr<AudioRequest> audioReq,
        telux::common::ErrorCode ec, CreatedTranscoderInfo createdTranscoderInfo)
        = 0;

    virtual void sendDeleteTranscoderResponse(std::shared_ptr<AudioRequest> audioReq,
    ...
    virtual void sendDTMFDetectedEvent(int clientId, uint32_t streamId, uint32_t lowFreq,
