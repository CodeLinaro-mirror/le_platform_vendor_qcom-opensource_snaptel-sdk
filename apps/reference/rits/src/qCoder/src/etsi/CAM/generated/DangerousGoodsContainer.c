...
static asn_SEQUENCE_specifics_t asn_SPC_DangerousGoodsContainer_specs_1 = {
    sizeof(struct DangerousGoodsContainer), offsetof(struct DangerousGoodsContainer, _asn_ctx),
    asn_MAP_DangerousGoodsContainer_tag2el_1, 1, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_DangerousGoodsContainer = {
    "DangerousGoodsContainer", "DangerousGoodsContainer", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_DangerousGoodsContainer_tags_1)
        / sizeof(asn_DEF_DangerousGoodsContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_DangerousGoodsContainer_1, 1, /* Elements count */
