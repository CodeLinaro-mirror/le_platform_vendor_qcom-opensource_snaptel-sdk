...
class SuppServicesManagerServerImpl final
   : public telStub::SuppServicesService::Service,
     public IServerEventListener,
     public std::enable_shared_from_this<SuppServicesManagerServerImpl> {
 ...
 public:
    ...
    grpc::Status SetOirPref(ServerContext *context, const ::telStub::SetOirPrefRequest *request,
