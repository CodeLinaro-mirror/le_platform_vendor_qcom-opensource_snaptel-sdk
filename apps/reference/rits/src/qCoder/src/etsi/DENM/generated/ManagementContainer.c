...
static asn_TYPE_member_t asn_MBR_ManagementContainer_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, actionID),
        ...
        &asn_DEF_ActionID, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "actionID"},
    {ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, detectionTime),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_TimestampIts, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "detectionTime"},
    ...
    {ATF_POINTER, 1, offsetof(struct ManagementContainer, termination),
        ...
        &asn_DEF_Termination, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "termination"},
    {ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, eventPosition),
        (ASN_TAG_CLASS_CONTEXT | (4 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_ReferencePosition, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "eventPosition"},
    {ATF_POINTER, 4, offsetof(struct ManagementContainer, relevanceDistance),
        ...
        &asn_DEF_RelevanceDistance, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "relevanceDistance"},
    {ATF_POINTER, 3, offsetof(struct ManagementContainer, relevanceTrafficDirection),
        ...
        &asn_DEF_RelevanceTrafficDirection, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
    ...
    {ATF_POINTER, 2, offsetof(struct ManagementContainer, validityDuration),
        ...
        &asn_DEF_ValidityDuration, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
    ...
    {ATF_POINTER, 1, offsetof(struct ManagementContainer, transmissionInterval),
        ...
        &asn_DEF_TransmissionInterval, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "transmissionInterval"},
    {ATF_NOFLAGS, 0, offsetof(struct ManagementContainer, stationType),
        (ASN_TAG_CLASS_CONTEXT | (9 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_StationType, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "stationType"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_ManagementContainer_specs_1 = {
    sizeof(struct ManagementContainer), offsetof(struct ManagementContainer, _asn_ctx),
    asn_MAP_ManagementContainer_tag2el_1, 10, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_ManagementContainer = {
    "ManagementContainer", "ManagementContainer", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_ManagementContainer_tags_1)
        / sizeof(asn_DEF_ManagementContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_ManagementContainer_1, 10, /* Elements count */
