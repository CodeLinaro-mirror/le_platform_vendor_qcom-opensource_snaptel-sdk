...
static asn_TYPE_member_t asn_MBR_EmergencyContainer_1[] = {
    ...
    {ATF_POINTER, 1, offsetof(struct EmergencyContainer, emergencyPriority),
        ...
        &asn_DEF_EmergencyPriority, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "emergencyPriority"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_EmergencyContainer_specs_1 = {
    sizeof(struct EmergencyContainer), offsetof(struct EmergencyContainer, _asn_ctx),
    asn_MAP_EmergencyContainer_tag2el_1, 3, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_EmergencyContainer = {
    "EmergencyContainer", "EmergencyContainer", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_EmergencyContainer_tags_1)
        / sizeof(asn_DEF_EmergencyContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_EmergencyContainer_1, 3, /* Elements count */
