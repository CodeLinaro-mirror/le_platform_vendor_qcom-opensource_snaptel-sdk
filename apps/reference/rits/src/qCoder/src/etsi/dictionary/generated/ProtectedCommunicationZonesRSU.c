...
static asn_per_constraints_t asn_PER_type_ProtectedCommunicationZonesRSU_constr_1 GCC_NOTUSED = {
    {APC_UNCONSTRAINED, -1, -1, 0, 0}, {APC_CONSTRAINED, 4, 4, 1, 16} /* (SIZE(1..16)) */, 0,
    0 /* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ProtectedCommunicationZonesRSU_1[] = {
    {ATF_POINTER, 0, 0, (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0,
        &asn_DEF_ProtectedCommunicationZone, 0, /* Defer constraints checking to the member type */
...
asn_TYPE_descriptor_t asn_DEF_ProtectedCommunicationZonesRSU = {
    "ProtectedCommunicationZonesRSU", "ProtectedCommunicationZonesRSU", SEQUENCE_OF_free,
    SEQUENCE_OF_print, SEQUENCE_OF_constraint, SEQUENCE_OF_decode_ber, SEQUENCE_OF_encode_der,
    SEQUENCE_OF_decode_xer, SEQUENCE_OF_encode_xer, SEQUENCE_OF_decode_uper,
    SEQUENCE_OF_encode_uper, 0, /* Use generic outmost tag fetcher */
    ...
    sizeof(asn_DEF_ProtectedCommunicationZonesRSU_tags_1)
        / sizeof(asn_DEF_ProtectedCommunicationZonesRSU_tags_1[0]), /* 1 */
    &asn_PER_type_ProtectedCommunicationZonesRSU_constr_1, asn_MBR_ProtectedCommunicationZonesRSU_1,
    1, /* Single element */
