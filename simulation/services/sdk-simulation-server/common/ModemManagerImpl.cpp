...
grpc::Status ModemManagerImpl::setOperatingMode(
...
grpc::Status ModemManagerImpl::getOperatingMode(
...
telux::common::ErrorCode ModemManagerImpl::getVoiceServiceState(
    int slotId, telStub::VoiceServiceStateInfo &serviceInfo) {
    telStub::VoiceServiceStateEvent event;
    telux::common::ErrorCode error
        = telux::tel::TelUtil::readVoiceServiceStateEventFromJsonFile(slotId, event);
...
telux::common::ErrorCode ModemManagerImpl::getSystemInfo(int slotId,
    ...
    telux::common::ErrorCode error
        = telux::tel::TelUtil::readSystemInfoFromJsonFile(slotId, servingRat, servingDomain);
    return error;
}

telux::common::ErrorCode ModemManagerImpl::getEcallOperatingMode(
    int slotId, telStub::ECallMode &mode) {
    telStub::ECallModeInfoChangeEvent event;
    telux::common::ErrorCode error
        = telux::tel::TelUtil::readEcallOperatingModeEventFromJsonFile(slotId, event);
