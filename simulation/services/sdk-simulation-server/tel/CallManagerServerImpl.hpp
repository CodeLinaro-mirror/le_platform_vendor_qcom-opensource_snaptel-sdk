...
class CallManagerServerImpl final : public telStub::DialerService::Service,
 ...
 public:
    ...
    grpc::Status GetServiceStatus(ServerContext *context, const google::protobuf::Empty *request,
        commonStub::GetServiceStatusReply *response) override;
    grpc::Status MakeECall(ServerContext *context, const telStub::MakeECallRequest *request,
    ...
    grpc::Status SetConfig(ServerContext *context, const telStub::SetConfigRequest *request,
        telStub::SetConfigReply *response);
    grpc::Status GetConfig(ServerContext *context, const ::google::protobuf::Empty *request,
    ...
    grpc::Status RequestEcbm(ServerContext *context, const telStub::RequestEcbmRequest *request,
        telStub::RequestEcbmReply *response);
    grpc::Status MakeCall(ServerContext *context, const telStub::MakeCallRequest *request,
        telStub::MakeCallReply *response);
    grpc::Status Reject(ServerContext *context, const telStub::RejectRequest *request,
        telStub::RejectReply *response);
    grpc::Status RejectWithSMS(ServerContext *context, const telStub::RejectWithSMSRequest *request,
        telStub::RejectWithSMSReply *response);
    grpc::Status Answer(ServerContext *context, const telStub::AnswerRequest *request,
    ...
    grpc::Status SendRtt(ServerContext *context, const telStub::SendRttRequest *request,
