...
static asn_TYPE_member_t asn_MBR_CamParameters_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct CamParameters, basicContainer),
        ...
        &asn_DEF_BasicContainer, 0, /* Defer constraints checking to the member type */
    ...
    {ATF_NOFLAGS, 0, offsetof(struct CamParameters, highFrequencyContainer),
        ...
        &asn_DEF_HighFrequencyContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "highFrequencyContainer"},
    {ATF_POINTER, 2, offsetof(struct CamParameters, lowFrequencyContainer),
        ...
        &asn_DEF_LowFrequencyContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "lowFrequencyContainer"},
    {ATF_POINTER, 1, offsetof(struct CamParameters, specialVehicleContainer),
        ...
        &asn_DEF_SpecialVehicleContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "specialVehicleContainer"},
};
static const int asn_MAP_CamParameters_oms_1[]            = {2, 3};
static const ber_tlv_tag_t asn_DEF_CamParameters_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
static asn_SEQUENCE_specifics_t asn_SPC_CamParameters_specs_1 = {
    sizeof(struct CamParameters), offsetof(struct CamParameters, _asn_ctx),
    asn_MAP_CamParameters_tag2el_1, 4, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_CamParameters = {
    "CamParameters", "CamParameters", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_CamParameters_tags_1) / sizeof(asn_DEF_CamParameters_tags_1[0]), /* 1 */
    asn_DEF_CamParameters_tags_1, /* Same as above */
    sizeof(asn_DEF_CamParameters_tags_1) / sizeof(asn_DEF_CamParameters_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_CamParameters_1, 4, /* Elements count */
