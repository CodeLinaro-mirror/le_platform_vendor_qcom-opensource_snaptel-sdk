...
static asn_SEQUENCE_specifics_t asn_SPC_RescueContainer_specs_1 = {
    sizeof(struct RescueContainer), offsetof(struct RescueContainer, _asn_ctx),
    asn_MAP_RescueContainer_tag2el_1, 1, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_RescueContainer = {
    "RescueContainer", "RescueContainer", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_RescueContainer_tags_1) / sizeof(asn_DEF_RescueContainer_tags_1[0]), /* 1 */
    asn_DEF_RescueContainer_tags_1, /* Same as above */
    sizeof(asn_DEF_RescueContainer_tags_1) / sizeof(asn_DEF_RescueContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_RescueContainer_1, 1, /* Elements count */
