...
static asn_TYPE_member_t asn_MBR_DecentralizedEnvironmentalNotificationMessage_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct DecentralizedEnvironmentalNotificationMessage, management),
        ...
        &asn_DEF_ManagementContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "management"},
    {ATF_POINTER, 3, offsetof(struct DecentralizedEnvironmentalNotificationMessage, situation),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_SituationContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "situation"},
    {ATF_POINTER, 2, offsetof(struct DecentralizedEnvironmentalNotificationMessage, location),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_LocationContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "location"},
    {ATF_POINTER, 1, offsetof(struct DecentralizedEnvironmentalNotificationMessage, alacarte),
        ...
        &asn_DEF_AlacarteContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "alacarte"},
};
...
asn_TYPE_descriptor_t asn_DEF_DecentralizedEnvironmentalNotificationMessage = {
    ...
    "DecentralizedEnvironmentalNotificationMessage", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_DecentralizedEnvironmentalNotificationMessage_tags_1)
        / sizeof(asn_DEF_DecentralizedEnvironmentalNotificationMessage_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_DecentralizedEnvironmentalNotificationMessage_1, 4, /* Elements count */
