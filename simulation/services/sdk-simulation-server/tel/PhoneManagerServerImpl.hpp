...
class PhoneManagerServerImpl final : public telStub::PhoneService::Service,
 ...
 public:
    ...
    grpc::Status GetPhoneIds(ServerContext *context, const google::protobuf::Empty *request,
        telStub::GetPhoneIdsReply *response) override;
    grpc::Status GetPhoneId(ServerContext *context, const google::protobuf::Empty *request,
    ...
    grpc::Status ResetWwan(ServerContext *context, const google::protobuf::Empty *request,
        telStub::ResetWwanReply *response) override;
    ...
    grpc::Status SetRadioPower(ServerContext *context, const telStub::SetRadioPowerRequest *request,
