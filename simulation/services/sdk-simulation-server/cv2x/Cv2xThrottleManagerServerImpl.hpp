...
class Cv2xThrottleManagerServerImpl final
 ...
 public:
    ...
    grpc::Status setVerificationLoad(ServerContext *context, const cv2xStub::UintNum *request,
 ...
 private:
    ...
    telux::common::ServiceStatus serviceStatus_ = telux::common::ServiceStatus::SERVICE_FAILED;
