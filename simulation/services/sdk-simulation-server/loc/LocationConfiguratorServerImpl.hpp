...
class LocationConfiguratorServerImpl final
   : public locStub::LocationConfiguratorService::Service,
 ...
 public:
    ...
    grpc::Status ConfigurePACE(ServerContext *context, const locStub::ConfigurePACERequest *request,
        locStub::LocManagerCommandReply *response);
    grpc::Status DeleteAllAidingData(ServerContext *context, const google::protobuf::Empty *request,
        locStub::LocManagerCommandReply *response);
    ...
    grpc::Status ConfigureDR(ServerContext *context, const locStub::ConfigureDRRequest *request,
        locStub::LocManagerCommandReply *response);
    ...
    grpc::Status ConfigureNmeaTypes(ServerContext *context,
        ...
        locStub::LocManagerCommandReply *response);
    grpc::Status ConfigureNmea(ServerContext *context, const locStub::ConfigureNmeaRequest *request,
        locStub::LocManagerCommandReply *response);
