...
class TelUtil {
 ...
 public:
    static telux::common::ErrorCode readFromJsonFile(
        int phoneId, std::string subsystem, Json::Value &rootObj, std::string &jsonfilename);
    static telux::common::ErrorCode readJsonData(
    ...
    static JsonData readSignalStrengthRespFromJsonFile(
        int phoneId, telStub::GetSignalStrengthReply *response);
    static JsonData readVoiceServiceStateRespFromJsonFile(
    ...
    static JsonData readCellInfoListRespFromJsonFile(
        int phoneId, telStub::RequestCellInfoListReply *response);
    static JsonData readEcallOperatingModeRespFromJsonFile(
    ...
    static JsonData readRequestOperatorInfoRespFromJsonFile(
        int phoneId, telStub::RequestOperatorInfoReply *response);

    static telux::common::ErrorCode readSignalStrengthEventFromJsonFile(
        int phoneId, telStub::SignalStrengthChangeEvent &event);
    static telux::common::ErrorCode readCellInfoListEventFromJsonFile(
        int phoneId, telStub::CellInfoListEvent &event);
    static telux::common::ErrorCode readVoiceServiceStateEventFromJsonFile(
    ...
    static telux::common::ErrorCode readRatPreferenceFromJsonFile(
        int phoneId, std::vector<int> &ratData);

    static telux::common::ErrorCode writeSignalStrengthToJsonFile(
        int phoneId, telStub::SignalStrengthChangeEvent &event);
    static telux::common::ErrorCode writeVoiceServiceStateToJsonFile(
        int phoneId, telStub::VoiceServiceStateEvent &event);
    ...
    static JsonData writeOperatingModeToJsonFileAndReply(
        telStub::OperatingMode mode, telStub::SetOperatingModeReply *response);
    static telux::common::ErrorCode writeSetCellInfoListRateToJsonFileAndReply(
        int cellInfoListRate, telStub::SetCellInfoListRateReply *response);
    static telux::common::ErrorCode writeSetRadioPowerToJsonFileAndReply(
    ...
    static telux::common::ErrorCode writeCellInfoListToJsonFile(
        std::vector<std::string> params, int &phoneId);
    static telux::common::ErrorCode writeVoiceServiceStateToJsonFile(
        std::string params, int &phoneId);
    static telux::common::ErrorCode writeOperatingModeToJsonFile(std::string params, int &phoneId);
    static telux::common::ErrorCode writeEcallOperatingModeToJsonFile(
        std::string params, int &phoneId);
    static telux::common::ErrorCode writeOperatorInfoToJsonFile(std::string params, int &phoneId);

    static telStub::SignalStrengthChangeEvent createSignalStrengthEvent(
