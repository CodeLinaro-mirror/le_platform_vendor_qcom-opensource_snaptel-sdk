...
private:
    ...
    ::dataStub::DdsInfo::DdsType convertDdsTypeStringToEnum(
        const std::string &ddsTypeStr);
    ::dataStub::RecommendationDetails::TemporaryRecommendationType
        convertTempTypeStringToEnum(const std::string &tempTypeStr);
    ::dataStub::TemporaryRecommendationCauseCodes
        convertTemporaryCauseStringToEnum(const std::string &causeStr);
    ::dataStub::PermanentRecommendationCauseCodes
        convertPermanentCauseStringToEnum(const std::string &causeStr);
