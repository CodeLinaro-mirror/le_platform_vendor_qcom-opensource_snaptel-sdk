...
class ServingSystemServerImpl final : public dataStub::DataServingSystemManager::Service,
 ...
 public:
    ...
    grpc::Status GetDrbStatus(ServerContext *context, const dataStub::GetDrbStatusRequest *request,
    ...
    grpc::Status RequestNrIconType(ServerContext *context,
        const dataStub::NrIconTypeRequest *request, dataStub::NrIconTypeReply *response) override;
 ...
 private:
    ...
    dataStub::NetworkRat::Rat convertNetworkRatStringToEnum(std::string nwRat);
    dataStub::RoamingType::Type convertRoamingTypeStringToEnum(std::string type);
    dataStub::NrIconType::Type convertNrIconTypeStringToEnum(std::string type);
};
