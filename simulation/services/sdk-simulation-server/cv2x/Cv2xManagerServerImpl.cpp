...
telux::common::ErrorCode Cv2xServerUtil::stateJasonRead(
    std::string stateCfgFile, Json::Value &data) {
    telux::common::ErrorCode err = JsonParser::readFromJsonFile(data, stateCfgFile);
...
Cv2xServerEvtListener::Cv2xServerEvtListener() {
    ...
    readDefaultStatus();
    injectEvtHdls_[CV2X_STATUS_EVENT] = std::bind(&Cv2xServerEvtListener::OnCv2xStatusChange, this,
...
void Cv2xServerEvtListener::readDefaultStatus() {
    ...
    if (telux::common::ErrorCode::SUCCESS
        ...
        stubStatus_.set_rxstatus(
            Cv2xServerUtil::strToStatus(data[RADIO_ROOT][method]["rxStatus"].asString()));
        stubStatus_.set_txstatus(
            Cv2xServerUtil::strToStatus(data[RADIO_ROOT][method]["txStatus"].asString()));
...
bool Cv2xServerEvtListener::stringToStatus(
    std::string &str, cv2xStub::Cv2xStatus &result, bool &needParseCause, bool rx) {
    std::string strToken = EventParserUtil::getNextToken(str, " ");
    ...
    if (cv2xStub::Cv2xStatus_StatusType_IsValid(static_cast<int>(token))) {
        ...
        if (cv2xStub::Cv2xStatus_StatusType::Cv2xStatus_StatusType_INACTIVE == token
            || cv2xStub::Cv2xStatus_StatusType::Cv2xStatus_StatusType_SUSPENDED == token) {
            needParseCause = true;
        }
        return true;
    } else {
        LOG(DEBUG, __FUNCTION__, " StatusTyp is not in range ", static_cast<int>(token));
    }
    return false;
}

bool Cv2xServerEvtListener::stringToCause(std::string &str, cv2xStub::Cv2xStatus &result, bool rx) {
    if (rx) {
...
bool Cv2xServerEvtListener::OnCv2xStatusChange(
    std::string str, ::eventService::EventResponse &ind) {
...
bool Cv2xServerEvtListener::handleMacCloneAttackInject(
    std::string str, ::eventService::EventResponse &ind) {
    LOG(DEBUG, __FUNCTION__);
...
bool Cv2xServerEvtListener::handleSlssRxInfoInject(
    std::string str, ::eventService::EventResponse &ind) {
    LOG(DEBUG, __FUNCTION__);
...
bool Cv2xServerEvtListener::handleSpsScheduleInject(
    std::string str, ::eventService::EventResponse &ind) {
    LOG(DEBUG, __FUNCTION__);
...
bool Cv2xServerEvtListener::handleSrcL2IdUpdateInject(
    std::string str, ::eventService::EventResponse &ind) {
    LOG(DEBUG, __FUNCTION__);
...
bool Cv2xServerEvtListener::handleCapabilitiesInject(
    std::string str, ::eventService::EventResponse &ind) {
    LOG(DEBUG, __FUNCTION__);
    ...
    if (pool.minfreq() > 0 && pool.minfreq() < 0x00FFFF && pool.maxfreq() > 0
        && pool.maxfreq() < 0x00FFFF) {
...
void Cv2xServerEvtListener::onEventUpdate(::eventService::UnsolicitedEvent message) {
    bool hasUpdate = false;
...
grpc::Status Cv2xManagerServerImpl::initService(ServerContext *context,
    const google::protobuf::Empty *request, cv2xStub::GetServiceStatusReply *res) {
    LOG(DEBUG, __FUNCTION__);
    int cbDelay                                = 100;
    telux::common::ServiceStatus serviceStatus = telux::common::ServiceStatus::SERVICE_FAILED;
    Json::Value rootNode;
    telux::common::ErrorCode errorCode = JsonParser::readFromJsonFile(rootNode, CV2X_MGR_API_JSON);
    if (errorCode == ErrorCode::SUCCESS) {
        cbDelay              = rootNode[CV2X_MGR_NODE]["IsSubsystemReadyDelay"].asInt();
        std::string cbStatus = rootNode[CV2X_MGR_NODE]["IsSubsystemReady"].asString();
...
grpc::Status Cv2xManagerServerImpl::startCv2x(ServerContext *context,
    const google::protobuf::Empty *request, cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "startCv2x", res);
    evtListener_->readDefaultStatus();
    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::stopCv2x(ServerContext *context,
    const google::protobuf::Empty *request, cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "stopCv2x", res);
    ::eventService::EventResponse dummy;
    evtListener_->OnCv2xStatusChange("inactive inactive 2 2", dummy);
    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::setPeakTxPower(ServerContext *context,
    const cv2xStub::Cv2xPeakTxPower *request, ::cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "setPeakTxPower", res);
    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::injectCoarseUtcTime(ServerContext *context,
    const ::cv2xStub::CoarseUtcTime *request, ::cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__, " utc: ", request->utc());
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "injectCoarseUtcTime", res);
    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::requestCv2xStatus(ServerContext *context,
    const google::protobuf::Empty *request, ::cv2xStub::Cv2xRequestStatusReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "requestCv2xStatus", res);
    if (evtListener_) {
...
grpc::Status Cv2xManagerServerImpl::getSlssRxInfo(ServerContext *context,
    const google::protobuf::Empty *request, ::cv2xStub::SlssRxInfoReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "getSlssRxInfo", res);
    ...
    ueInfo->set_pattern(static_cast<::cv2xStub::SyncRefUeInfo::SlssSyncPattern>(pattern));
    ueInfo->set_rsrp(rsrp);
    ueInfo->set_selected(selected);

    LOG(DEBUG, __FUNCTION__, " slssId: ", ueInfo->slssid(), " inCoverage: ", ueInfo->incoverage());

    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::setL2Filters(ServerContext *context,
    const ::cv2xStub::L2FilterInfos *request, ::cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "setL2Filters", res);
    return grpc::Status::OK;
}

grpc::Status Cv2xManagerServerImpl::removeL2Filters(
    ServerContext *context, const ::cv2xStub::L2Ids *request, ::cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);
    Cv2xServerUtil::apiJsonReader(CV2X_MGR_API_JSON, CV2X_MGR_NODE, "removeL2Filters", res);
    return grpc::Status::OK;
}
