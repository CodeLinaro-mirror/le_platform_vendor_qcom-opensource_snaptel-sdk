...
class ICommunicator {
 public:
    ...
    virtual telux::common::Status registerForVoiceStreamEvents(
    ...
    virtual telux::common::Status getDevice(
    ...
    virtual telux::common::Status getVolume(uint32_t streamId,
    ...
    virtual telux::common::Status getMute(uint32_t streamId,
        telux::audio::StreamDirection direction,
        std::shared_ptr<telux::audio::ISetGetMuteCb> resultListener, int cmdId)
        = 0;
