...
class ThermalGrpcServerImpl final : public thermStub::Thermal::Service,
 ...
 public:
    ...
    grpc::Status RegisterOnTripEvent(ServerContext *context, const google::protobuf::Empty *request,
 ...
 private:
    ...
    telux::common::Status sendTripUpdateEvent(
        std::shared_ptr<telux::therm::ITripPoint> &tp, int tZoneId, int event);
    telux::common::Status sendCdevUpdateEvent(
    ...
    telux::common::Status getTripUpdate(
    ...
    template <class T>
    grpc::Status registerNotification(ServerWriter<T> *writer,
        std::map<uint16_t, ServerWriter<T> *> &writerList, std::mutex &mutex,
        std::condition_variable &cv, uint16_t &clientId) {
    ...
    grpc::Status registerTripEvent(ServerWriter<::thermStub::RegisterOnTripEventReply> *response);
 ...
 private:
    std::shared_ptr<telux::therm::CoolingDeviceImpl> setCoolingDevice(
    ...
    std::map<uint16_t, ServerWriter<thermStub::RegisterOnTripEventReply> *> onTripEventReplyWriters_;
