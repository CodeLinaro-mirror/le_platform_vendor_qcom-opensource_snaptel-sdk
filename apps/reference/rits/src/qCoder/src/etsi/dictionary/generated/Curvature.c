...
static asn_TYPE_member_t asn_MBR_Curvature_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct Curvature, curvatureValue), (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
        -1, /* IMPLICIT tag at current level */
        &asn_DEF_CurvatureValue, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "curvatureValue"},
    {ATF_NOFLAGS, 0, offsetof(struct Curvature, curvatureConfidence),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_CurvatureConfidence, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "curvatureConfidence"},
};
static const ber_tlv_tag_t asn_DEF_Curvature_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
asn_TYPE_descriptor_t asn_DEF_Curvature = {
    "Curvature", "Curvature", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_Curvature_tags_1) / sizeof(asn_DEF_Curvature_tags_1[0]), /* 1 */
    asn_DEF_Curvature_tags_1, /* Same as above */
    sizeof(asn_DEF_Curvature_tags_1) / sizeof(asn_DEF_Curvature_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_Curvature_1, 2, /* Elements count */
