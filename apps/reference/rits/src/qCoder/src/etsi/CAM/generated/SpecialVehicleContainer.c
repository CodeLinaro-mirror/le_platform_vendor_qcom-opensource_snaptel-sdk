...
static asn_TYPE_member_t asn_MBR_SpecialVehicleContainer_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.publicTransportContainer),
        ...
        &asn_DEF_PublicTransportContainer, 0, /* Defer constraints checking to the member type */
    ...
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.specialTransportContainer),
        ...
        &asn_DEF_SpecialTransportContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "specialTransportContainer"},
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.dangerousGoodsContainer),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_DangerousGoodsContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "dangerousGoodsContainer"},
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.roadWorksContainerBasic),
        ...
        &asn_DEF_RoadWorksContainerBasic, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "roadWorksContainerBasic"},
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.rescueContainer),
        ...
        &asn_DEF_RescueContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "rescueContainer"},
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.emergencyContainer),
        ...
        &asn_DEF_EmergencyContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "emergencyContainer"},
    {ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, choice.safetyCarContainer),
        ...
        &asn_DEF_SafetyCarContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "safetyCarContainer"},
};
...
static asn_CHOICE_specifics_t asn_SPC_SpecialVehicleContainer_specs_1 = {
    sizeof(struct SpecialVehicleContainer), offsetof(struct SpecialVehicleContainer, _asn_ctx),
    offsetof(struct SpecialVehicleContainer, present),
    sizeof(((struct SpecialVehicleContainer *)0)->present),
    asn_MAP_SpecialVehicleContainer_tag2el_1, 7, /* Count of tags in the map */
    0, 7 /* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_SpecialVehicleContainer = {
    "SpecialVehicleContainer", "SpecialVehicleContainer", CHOICE_free, CHOICE_print,
    CHOICE_constraint, CHOICE_decode_ber, CHOICE_encode_der, CHOICE_decode_xer, CHOICE_encode_xer,
    CHOICE_decode_uper, CHOICE_encode_uper, CHOICE_outmost_tag, 0, /* No effective tags (pointer) */
    0, /* No effective tags (count) */
    0, /* No tags (pointer) */
    0, /* No tags (count) */
    &asn_PER_type_SpecialVehicleContainer_constr_1, asn_MBR_SpecialVehicleContainer_1,
    7, /* Elements count */
