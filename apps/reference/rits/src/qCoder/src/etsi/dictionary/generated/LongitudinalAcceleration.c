...
static asn_TYPE_member_t asn_MBR_LongitudinalAcceleration_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct LongitudinalAcceleration, longitudinalAccelerationValue),
        ...
        0, "longitudinalAccelerationValue"},
    {ATF_NOFLAGS, 0, offsetof(struct LongitudinalAcceleration, longitudinalAccelerationConfidence),
        ...
        0, /* No PER visible constraints */
        0, "longitudinalAccelerationConfidence"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_LongitudinalAcceleration_specs_1 = {
    sizeof(struct LongitudinalAcceleration), offsetof(struct LongitudinalAcceleration, _asn_ctx),
    asn_MAP_LongitudinalAcceleration_tag2el_1, 2, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_LongitudinalAcceleration = {
    "LongitudinalAcceleration", "LongitudinalAcceleration", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_LongitudinalAcceleration_tags_1)
        / sizeof(asn_DEF_LongitudinalAcceleration_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_LongitudinalAcceleration_1, 2, /* Elements count */
