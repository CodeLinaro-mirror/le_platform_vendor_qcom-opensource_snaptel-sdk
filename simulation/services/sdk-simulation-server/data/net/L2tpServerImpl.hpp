...
class L2tpServerImpl final : public dataStub::L2tpManager::Service {
 public:
    L2tpServerImpl();
    ~L2tpServerImpl();
    ...
    grpc::Status SetConfig(ServerContext *context, const dataStub::SetConfigRequest *request,
        dataStub::DefaultReply *response) override;

    grpc::Status RequestConfig(ServerContext *context, const google::protobuf::Empty *request,
        dataStub::RequestConfigReply *response) override;

    grpc::Status AddTunnel(ServerContext *context, const ::dataStub::AddTunnelRequest *request,
        ::dataStub::DefaultReply *response) override;
    ...
    grpc::Status AddSession(ServerContext *context, const ::dataStub::AddSessionRequest *request,
        ::dataStub::DefaultReply *response) override;
    ...
    grpc::Status BindSessionToBackhaul(ServerContext *context,
        const dataStub::SessionConfigRequest *request, dataStub::DefaultReply *response) override;
 ...
 private:
    ...
    bool bindingExists(
        const Json::Value &bindingsObj, const dataStub::SessionConfigRequest *request, int &idx);
