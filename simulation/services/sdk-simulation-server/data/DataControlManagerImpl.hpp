...
class DataControlServerImpl final : public dataStub::DualDataManager::Service,
 ...
 public:
    ...
    grpc::Status SetDataStallParams(ServerContext *context,
        dataStub::SetDataStallParamsReply request,
        dataStub::SetDataStallParamsReply *response) private
