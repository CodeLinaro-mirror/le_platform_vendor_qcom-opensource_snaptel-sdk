...
static asn_TYPE_member_t asn_MBR_PosConfidenceEllipse_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct PosConfidenceEllipse, semiMajorConfidence),
        ...
        &asn_DEF_SemiAxisLength, 0, /* Defer constraints checking to the member type */
...
static asn_SEQUENCE_specifics_t asn_SPC_PosConfidenceEllipse_specs_1 = {
    sizeof(struct PosConfidenceEllipse), offsetof(struct PosConfidenceEllipse, _asn_ctx),
    asn_MAP_PosConfidenceEllipse_tag2el_1, 3, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_PosConfidenceEllipse = {
    "PosConfidenceEllipse", "PosConfidenceEllipse", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_PosConfidenceEllipse_tags_1)
        / sizeof(asn_DEF_PosConfidenceEllipse_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_PosConfidenceEllipse_1, 3, /* Elements count */
