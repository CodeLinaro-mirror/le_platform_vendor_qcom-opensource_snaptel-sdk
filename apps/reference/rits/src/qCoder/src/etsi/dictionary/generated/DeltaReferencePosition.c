...
static asn_TYPE_member_t asn_MBR_DeltaReferencePosition_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct DeltaReferencePosition, deltaLatitude),
        ...
        &asn_DEF_DeltaLatitude, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "deltaLatitude"},
    {ATF_NOFLAGS, 0, offsetof(struct DeltaReferencePosition, deltaLongitude),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_DeltaLongitude, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "deltaLongitude"},
    {ATF_NOFLAGS, 0, offsetof(struct DeltaReferencePosition, deltaAltitude),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_DeltaAltitude, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "deltaAltitude"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_DeltaReferencePosition_specs_1 = {
    sizeof(struct DeltaReferencePosition), offsetof(struct DeltaReferencePosition, _asn_ctx),
    asn_MAP_DeltaReferencePosition_tag2el_1, 3, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_DeltaReferencePosition = {
    "DeltaReferencePosition", "DeltaReferencePosition", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_DeltaReferencePosition_tags_1)
        / sizeof(asn_DEF_DeltaReferencePosition_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_DeltaReferencePosition_1, 3, /* Elements count */
