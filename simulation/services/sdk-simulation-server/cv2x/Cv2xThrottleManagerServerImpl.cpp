...
grpc::Status Cv2xThrottleManagerServerImpl::initService(ServerContext *context,
    ...
    if (errorCode == ErrorCode::SUCCESS) {
        ...
        std::string cbStatus = rootNode[CV2X_THROTTLE_MGR_NODE]["IsSubsystemReady"].asString();
...
grpc::Status Cv2xThrottleManagerServerImpl::getServiceStatus(ServerContext *context,
    const google::protobuf::Empty *request, cv2xStub::GetServiceStatusReply *res) {
    LOG(DEBUG, __FUNCTION__);
    int cbDelay = 100;
...
grpc::Status Cv2xThrottleManagerServerImpl::setVerificationLoad(
    ServerContext *context, const cv2xStub::UintNum *request, cv2xStub::Cv2xCommandReply *res) {
    LOG(DEBUG, __FUNCTION__);

    Cv2xServerUtil::apiJsonReader(
        CV2X_THROTTLE_MGR_API_JSON, CV2X_THROTTLE_MGR_NODE, "setVerificationLoad", res);
