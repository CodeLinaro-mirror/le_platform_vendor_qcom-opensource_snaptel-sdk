...
class ImsSettingsManagerServerImpl final
   : public telStub::ImsService::Service,
     public IServerEventListener,
     public std::enable_shared_from_this<ImsSettingsManagerServerImpl> {
 ...
 public:
    ...
    grpc::Status RequestVonr(ServerContext *context, const ::telStub::RequestVonrRequest *request,
        telStub::RequestVonrReply *response) override;
    grpc::Status SetVonr(ServerContext *context, const ::telStub::SetVonrRequest *request,
 ...
 private:
    ...
    void triggerImsSipUserAgentChange(
