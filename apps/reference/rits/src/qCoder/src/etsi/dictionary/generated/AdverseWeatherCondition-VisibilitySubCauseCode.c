...
int AdverseWeatherCondition_VisibilitySubCauseCode_constraint(asn_TYPE_descriptor_t *td,
 ...
 */
static void AdverseWeatherCondition_VisibilitySubCauseCode_1_inherit_TYPE_descriptor(
...
void AdverseWeatherCondition_VisibilitySubCauseCode_free(
...
int AdverseWeatherCondition_VisibilitySubCauseCode_print(asn_TYPE_descriptor_t *td,
    const void *struct_ptr, int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
    AdverseWeatherCondition_VisibilitySubCauseCode_1_inherit_TYPE_descriptor(td);
    return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}

asn_dec_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_decode_ber(
...
asn_enc_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_encode_der(asn_TYPE_descriptor_t *td,
    void *structure, int tag_mode, ber_tlv_tag_t tag, asn_app_consume_bytes_f *cb, void *app_key) {
    AdverseWeatherCondition_VisibilitySubCauseCode_1_inherit_TYPE_descriptor(td);
    return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
}

asn_dec_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_decode_xer(
...
asn_enc_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_encode_xer(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_decode_uper(
...
asn_enc_rval_t AdverseWeatherCondition_VisibilitySubCauseCode_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_AdverseWeatherCondition_VisibilitySubCauseCode = {
    ...
    sizeof(asn_DEF_AdverseWeatherCondition_VisibilitySubCauseCode_tags_1)
        / sizeof(asn_DEF_AdverseWeatherCondition_VisibilitySubCauseCode_tags_1[0]), /* 1 */
    &asn_PER_type_AdverseWeatherCondition_VisibilitySubCauseCode_constr_1, 0,
    0, /* Defined elsewhere */
    0 /* No specifics */
};
