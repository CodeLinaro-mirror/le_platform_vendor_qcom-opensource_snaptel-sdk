...
static asn_TYPE_member_t asn_MBR_ImpactReductionContainer_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, heightLonCarrLeft),
        ...
        &asn_DEF_HeightLonCarr, 0, /* Defer constraints checking to the member type */
    ...
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, heightLonCarrRight),
        ...
        &asn_DEF_HeightLonCarr, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "heightLonCarrRight"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, posLonCarrLeft),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_PosLonCarr, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "posLonCarrLeft"},
    ...
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, positionOfPillars),
        ...
        &asn_DEF_PositionOfPillars, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "positionOfPillars"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, posCentMass),
        ...
        &asn_DEF_PosCentMass, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "posCentMass"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, wheelBaseVehicle),
        ...
        &asn_DEF_WheelBaseVehicle, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "wheelBaseVehicle"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, turningRadius),
        ...
        &asn_DEF_TurningRadius, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "turningRadius"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, posFrontAx),
        ...
        &asn_DEF_PosFrontAx, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "posFrontAx"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, positionOfOccupants),
        ...
        &asn_DEF_PositionOfOccupants, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "positionOfOccupants"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, vehicleMass),
        ...
        &asn_DEF_VehicleMass, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "vehicleMass"},
    {ATF_NOFLAGS, 0, offsetof(struct ImpactReductionContainer, requestResponseIndication),
        ...
        &asn_DEF_RequestResponseIndication, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
...
static asn_SEQUENCE_specifics_t asn_SPC_ImpactReductionContainer_specs_1 = {
    sizeof(struct ImpactReductionContainer), offsetof(struct ImpactReductionContainer, _asn_ctx),
    asn_MAP_ImpactReductionContainer_tag2el_1, 12, /* Count of tags in the map */
    0, 0, 0, /* Optional elements (not needed) */
    -1, /* Start extensions */
    -1 /* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ImpactReductionContainer = {
    "ImpactReductionContainer", "ImpactReductionContainer", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_ImpactReductionContainer_tags_1)
        / sizeof(asn_DEF_ImpactReductionContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_ImpactReductionContainer_1, 12, /* Elements count */
