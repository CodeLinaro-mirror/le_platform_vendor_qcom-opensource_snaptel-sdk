...
void SensorFeatureManagerStub::onTcuActivityStateUpdate(
    TcuActivityState state, std::string machineName) {
    LOG(DEBUG, __FUNCTION__);
...
void SensorFeatureManagerStub::invokeBufferedEventListener(
