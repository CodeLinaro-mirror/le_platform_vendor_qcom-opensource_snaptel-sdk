...
class KeepAliveManagerStub : public IKeepAliveManager,
 ...
 public:
    ...
    telux::common::ErrorCode startTCPKeepAliveOffload(const TCPKAParams &tcpKaParams,
        const TCPSessionParams &tcpSessionParams, const uint32_t interval,
        TCPKAOffloadHandle &handle) override;

    telux::common::ErrorCode startTCPKeepAliveOffload(const MonitorHandleType monHandle,
