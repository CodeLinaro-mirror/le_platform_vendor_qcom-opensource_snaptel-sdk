...
grpc::Status PhoneManagerServerImpl::SetRadioPower(ServerContext *context,
    ...
    LOG(DEBUG, __FUNCTION__);
    telux::common::ErrorCode error = telux::tel::TelUtil::writeSetRadioPowerToJsonFileAndReply(
        request->phone_id(), request->enable(), response);
...
grpc::Status PhoneManagerServerImpl::GetSignalStrength(ServerContext *context,
    const telStub::GetSignalStrengthRequest *request, telStub::GetSignalStrengthReply *response) {
    LOG(DEBUG, __FUNCTION__);
    int phoneId   = request->phone_id();
...
grpc::Status PhoneManagerServerImpl::SetECallOperatingMode(ServerContext *context,
    ...
    error
        = telux::tel::TelUtil::readEcallOperatingModeEventFromJsonFile(phoneId, operatingModeEvent);
...
void PhoneManagerServerImpl::handleSignalStrengthChanged(std::string eventParams) {
    ...
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::writeSignalStrengthToJsonFile(params, phoneId, notify);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
        ::telStub::SignalStrengthChangeEvent signalStrengthChangeEvent;
        errorCode = telux::tel::TelUtil::readSignalStrengthEventFromJsonFile(
            phoneId, signalStrengthChangeEvent);
...
void PhoneManagerServerImpl::handleCellInfoChanged(std::string eventParams) {
    ...
    int phoneId;
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::writeCellInfoListToJsonFile(params, phoneId);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
        ::telStub::CellInfoListEvent cellInfoListEvent;
        errorCode
            = telux::tel::TelUtil::readCellInfoListEventFromJsonFile(phoneId, cellInfoListEvent);
...
void PhoneManagerServerImpl::handleVoiceServiceStateChanged(std::string eventParams) {
    ...
    int phoneId;
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::writeVoiceServiceStateToJsonFile(eventParams, phoneId);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
        ::telStub::VoiceServiceStateEvent voiceServiceStateEvent;
        errorCode = telux::tel::TelUtil::readVoiceServiceStateEventFromJsonFile(
            phoneId, voiceServiceStateEvent);
...
void PhoneManagerServerImpl::handleOperatingModeChanged(std::string eventParams) {
    ...
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::readOperatingModeEventFromJsonFile(oldOperatingModeEvent);
    errorCode = telux::tel::TelUtil::writeOperatingModeToJsonFile(eventParams, phoneId);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
...
void PhoneManagerServerImpl::handleECallOperatingModeChanged(std::string eventParams) {
    ...
    int phoneId;
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::writeEcallOperatingModeToJsonFile(eventParams, phoneId);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
        ::telStub::ECallModeInfoChangeEvent operatingModeEvent;
        errorCode = telux::tel::TelUtil::readEcallOperatingModeEventFromJsonFile(
            phoneId, operatingModeEvent);
...
void PhoneManagerServerImpl::handleOperatorInfoChanged(std::string eventParams) {
    ...
    int phoneId;
    telux::common::ErrorCode errorCode
        = telux::tel::TelUtil::writeOperatorInfoToJsonFile(eventParams, phoneId);
    if (errorCode == telux::common::ErrorCode::SUCCESS) {
        ::telStub::OperatorInfoEvent operatorInfoEvent;
        errorCode
            = telux::tel::TelUtil::readOperatorInfoEventFromJsonFile(phoneId, operatorInfoEvent);
        if (errorCode == telux::common::ErrorCode::SUCCESS) {
            ::eventService::EventResponse anyResponse;
            anyResponse.set_filter(telux::tel::TEL_PHONE_FILTER);
            // Notify modem manager
