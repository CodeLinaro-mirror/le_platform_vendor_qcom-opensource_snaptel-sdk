...
telux::common::ErrorCode TelUtil::readFromJsonFile(
    int phoneId, std::string subsystem, Json::Value &rootObj, std::string &jsonfilename) {
...
telux::common::ErrorCode TelUtil::readJsonData(
    int phoneId, std::string subsystem, std::string method, JsonData &data) {
...
JsonData TelUtil::readGetPhoneIdsRespFromJsonFile(telStub::GetPhoneIdsReply *response) {
    ...
    if (ErrorCode::SUCCESS
        != readJsonData(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "getPhoneIds", data)) {
...
JsonData TelUtil::readGetPhoneIdRespFromJsonFile(telStub::GetPhoneIdReply *response) {
    ...
    telux::common::ErrorCode error
        = readJsonData(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "getPhoneId", data);
...
JsonData TelUtil::readSignalStrengthRespFromJsonFile(
    int phoneId, telStub::GetSignalStrengthReply *response) {
    LOG(DEBUG, __FUNCTION__);
    JsonData data;
    telux::common::ErrorCode error
        = readJsonData(phoneId, TEL_PHONE_MANAGER, "requestSignalStrength", data);
    if (ErrorCode::SUCCESS != error) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return data;
    }
    if (data.status == telux::common::Status::SUCCESS) {
        ...
        if (servingRat == telStub::RadioTechnology::RADIO_TECH_GSM
            ...
            response->mutable_signal_strength()
                ...
                ->set_gsm_signal_strength(
                    data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthIn"
                                                                               "fo"]["gsmSignalStre"
                                                                                     "ngth"]
                        .asInt());
            response->mutable_signal_strength()
                ->mutable_gsm_signal_strength_info()
                ->set_gsm_bit_error_rate(
                    data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthIn"
                                                                               "fo"]["gsmBitErrorRa"
                                                                                     "te"]
                        .asInt());
            response->mutable_signal_strength()->mutable_gsm_signal_strength_info()->set_gsm_rssi(
        ...
        if (servingRat == telStub::RadioTechnology::RADIO_TECH_LTE
            ...
            response->mutable_signal_strength()
                ...
                ->set_lte_signal_strength(
                    data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthIn"
                                                                               "fo"]["lteSignalStre"
                                                                                     "ngth"]
                        .asInt());
            ...
            response->mutable_signal_strength()
                ...
                ->set_timing_advance(data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                                      ["lteSignalStrengthInfo"]["timingAdvance"]
                                                          .asInt());
            response->mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_rssi(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]
                                 ["lteRssi"]
                                     .asInt());
        } else {
        ...
        if (servingRat == telStub::RadioTechnology::RADIO_TECH_UMTS
            ...
            response->mutable_signal_strength()
                ...
                ->set_signal_strength(data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                                       ["wcdmaSignalStrengthInfo"]["signalStrength"]
                                                           .asInt());
            response->mutable_signal_strength()
                ->mutable_wcdma_signal_strength_info()
                ->set_bit_error_rate(data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                                      ["wcdmaSignalStrengthInfo"]["bitErrorRate"]
                                                          .asInt());
            response->mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_ecio(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInf"
                                                                           "o"]["ecio"]
                    .asInt());
            response->mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_rscp(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInf"
                                                                           "o"]["rscp"]
                    .asInt());
            response->mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_rssi(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInf"
                                                                           "o"]["rssi"]
                    .asInt());
        } else {
        ...
        if (servingRat == telStub::RadioTechnology::RADIO_TECH_NR5G
            ...
            response->mutable_signal_strength()->mutable_nr5g_signal_strength_info()->set_rsrp(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nr5gSignalStrengthInfo"]
                                 ["rsrp"]
                                     .asInt());
        ...
        if (servingRat == telStub::RadioTechnology::RADIO_TECH_NB1_NTN) {
            response->mutable_signal_strength()
                ...
                ->set_signal_strength(
                    data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengt"
                                                                               "hInfo"]["signalStre"
                                                                                        "ngth"]
                        .asInt());
            response->mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_rsrp(
                data.stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInf"
                                                                           "o"]["rsrp"]
                    .asInt());
...
JsonData TelUtil::readVoiceServiceStateRespFromJsonFile(
    int phoneId, telStub::RequestVoiceServiceStateReply *response) {
    JsonData data;
    if (ErrorCode::SUCCESS
        != readJsonData(phoneId, TEL_PHONE_MANAGER, "requestVoiceServiceState", data)) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return data;
    }
    if (data.status == telux::common::Status::SUCCESS) {
        ...
        telStub::ServiceDomainInfo_Domain servingDomain;
        telux::common::ErrorCode error
            = TelUtil::readSystemInfoFromJsonFile(phoneId, servingRat, servingDomain);
        data.error = error;
        if (error != ErrorCode::SUCCESS) {
            LOG(ERROR, __FUNCTION__, " Reading System Info failed");
            data.status = telux::common::Status::FAILED;
        ...
        if (event.operating_mode() == telStub::OperatingMode::ONLINE) {
            telStub::VoiceServiceState voiceServiceState = static_cast<telStub::VoiceServiceState>(
                data.stateRootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceState"]
                    .asInt());
            LOG(DEBUG, __FUNCTION__,
                " VoiceServiceState is :", static_cast<int>(voiceServiceState));
            response->mutable_voice_service_state_info()->set_voice_service_state(
                voiceServiceState);
            telStub::VoiceServiceDenialCause voiceServiceDenialCause
                = static_cast<telStub::VoiceServiceDenialCause>(
                    data.stateRootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceDeni"
                                                                                  "alCause"]
                        .asInt());
            LOG(DEBUG, __FUNCTION__,
                " VoiceServiceDenialCause is :", static_cast<int>(voiceServiceDenialCause));
...
JsonData TelUtil::readCellularCapabilitiesRespFromJsonFile(
    ...
    if (ErrorCode::SUCCESS
        != readJsonData(
            DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "requestCellularCapabilityInfo", data)) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return data;
    }
    if (data.status == telux::common::Status::SUCCESS) {
        int size
            = data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["voiceTech"].size();

        for (auto index = 0; index < size; index++) {
            response->mutable_capability_info()->add_voice_service_techs(convertVoiceTechStringToEnum(
                data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["voiceTech"][index]
                    .asString()));
        }
        response->mutable_capability_info()->set_sim_count(
            data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["simCount"].asInt());
        response->mutable_capability_info()->set_max_active_sims(
            data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["maxActiveSims"].asInt());
        int simRATCapSize
            = data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["SimRATCapabilities"]
                  .size();
        for (auto i = 0; i < simRATCapSize; i++) {
            telStub::SimRatCapability *simCaps
                = response->mutable_capability_info()->add_sim_rat_capabilities();
            simCaps->set_phone_id(data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]
                                                   ["SimRATCapabilities"][i]["slotId"]
                                                       .asInt());
            int ratCapSize = data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]
                                              ["SimRATCapabilities"][i]["capabilities"]
                                                  .size();
            for (auto j = 0; j < ratCapSize; j++) {
                simCaps->add_capabilities(convertRATCapStringToEnum(
                    data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]
                                     ["SimRATCapabilities"][i]["capabilities"][j]
                                         .asString()));
            }
        }
        int deviceRATCapSize
            = data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["DeviceRATCapabilitie"
                                                                             "s"]
                  .size();
        for (auto i = 0; i < deviceRATCapSize; i++) {
            ...
            deviceCaps->set_phone_id(
                data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]["DeviceRATCapabiliti"
                                                                               "es"][i]["slotId"]
                    .asInt());
            int sizeDeviceCap = data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]
                                                 ["DeviceRATCapabilities"][i]["capabilities"]
                                                     .size();
            for (auto j = 0; j < sizeDeviceCap; j++) {
                deviceCaps->add_capabilities(convertRATCapStringToEnum(
                    data.stateRootObj[TEL_PHONE_MANAGER]["cellularCapabilityInfo"]
                                     ["DeviceRATCapabilities"][i]["capabilities"][j]
                                         .asString()));
            }
        }
    }
...
JsonData TelUtil::readOperatingModeRespFromJsonFile(telStub::GetOperatingModeReply *response) {
    ...
    JsonData data;
    telux::common::ErrorCode error
        = readJsonData(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "requestOperatingMode", data);
    if (ErrorCode::SUCCESS != error) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return data;
    }
    if (data.status == telux::common::Status::SUCCESS) {
        int opMode
            = data.stateRootObj[TEL_PHONE_MANAGER]["operatingModeInfo"]["operatingMode"].asInt();
...
JsonData TelUtil::readCellInfoListRespFromJsonFile(
    int phoneId, telStub::RequestCellInfoListReply *response) {
    JsonData data;
            ...
            for (int i = 0; i < newCellCount; i++) {
                ...
                switch (cellType) {
                    case telStub::CellInfo_CellType_GSM: {
                        ...
                        // signal strength
                        cellInfo->mutable_gsm_cell_info()
                            ->mutable_gsm_signal_strength_info()
                            ->set_gsm_signal_strength(
                                requestedCell["gsmCellInfo"]["gsmSignalStrengthInfo"]["gsmSignalStr"
                                                                                      "ength"]
                                    .asInt());
                        cellInfo->mutable_gsm_cell_info()
                            ->mutable_gsm_signal_strength_info()
                            ->set_gsm_bit_error_rate(
                                requestedCell["gsmCellInfo"]["gsmSignalStrengthInfo"]["gsmBitErrorR"
                                                                                      "ate"]
                                    .asInt());
                        cellInfo->mutable_gsm_cell_info()
                            ->mutable_gsm_signal_strength_info()
                            ->set_gsm_rssi(
                                requestedCell["gsmCellInfo"]["gsmSignalStrengthInfo"]["gsmRssi"]
                                    .asInt());
                        break;
                    }
                    case telStub::CellInfo_CellType_LTE: {
                        ...
                        // signal strength
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_signal_strength(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteSignalStr"
                                                                                      "ength"]
                                    .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_rsrp(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteRsrp"]
                                    .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_rsrq(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteRsrq"]
                                    .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_rssnr(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteRssnr"]
                                    .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_cqi(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteCqi"]
                                    .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_timing_advance(requestedCell["lteCellInfo"]["lteSignalStrengthInf"
                                                                              "o"]["timingAdvance"]
                                                     .asInt());
                        cellInfo->mutable_lte_cell_info()
                            ->mutable_lte_signal_strength_info()
                            ->set_lte_rssi(
                                requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteRssi"]
                                    .asInt());
                        break;
                    }
                    case telStub::CellInfo_CellType_WCDMA: {
                        ...
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_cell_identity()
                            ->set_uarfcn(
                                requestedCell["wcdmaCellInfo"]["wcdmaCellIdentity"]["uarfcn"]
                                    .asInt());
                        // signal strength
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_signal_strength_info()
                            ->set_signal_strength(
                                requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["signalSt"
                                                                                          "rength"]
                                    .asInt());
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_signal_strength_info()
                            ->set_bit_error_rate(
                                requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["bitError"
                                                                                          "Rate"]
                                    .asInt());
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_signal_strength_info()
                            ->set_ecio(
                                requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["ecio"]
                                    .asInt());
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_signal_strength_info()
                            ->set_rscp(
                                requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["rscp"]
                                    .asInt());
                        cellInfo->mutable_wcdma_cell_info()
                            ->mutable_wcdma_signal_strength_info()
                            ->set_rssi(
                                requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["rssi"]
                                    .asInt());
                        break;
                    }
                    case telStub::CellInfo_CellType_NR5G: {
                        ...
                        // signal strength
                        cellInfo->mutable_nr5g_cell_info()
                            ->mutable_nr5g_signal_strength_info()
                            ->set_rsrp(
                                requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rsrp"]
                                    .asInt());
                        cellInfo->mutable_nr5g_cell_info()
                            ->mutable_nr5g_signal_strength_info()
                            ->set_rsrq(
                                requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rsrq"]
                                    .asInt());
                        cellInfo->mutable_nr5g_cell_info()
                            ->mutable_nr5g_signal_strength_info()
                            ->set_rssnr(
                                requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rssnr"]
                                    .asInt());
                        break;
                    }
                    case telStub::CellInfo_CellType_NB1_NTN: {
                        ...
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_cell_identity()
                            ->set_mcc(requestedCell["nb1NtnCellInfo"]["nb1NtnCellIdentity"]["mcc"]
                                          .asString());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_cell_identity()
                            ->set_mnc(requestedCell["nb1NtnCellInfo"]["nb1NtnCellIdentity"]["mnc"]
                                          .asString());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_cell_identity()
                            ->set_ci(
                        ...
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_cell_identity()
                            ->set_tac(requestedCell["nb1NtnCellInfo"]["nb1NtnCellIdentity"]["tac"]
                                          .asInt());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_cell_identity()
                            ->set_earfcn(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnCellIdentity"]["earfcn"]
                                    .asInt());
                        // signal strength
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_signal_strength_info()
                            ->set_signal_strength(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["signal"
                                                                                            "Streng"
                                                                                            "th"]
                                    .asInt());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_signal_strength_info()
                            ->set_rsrp(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["rsrp"]
                                    .asInt());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_signal_strength_info()
                            ->set_rsrq(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["rsrq"]
                                    .asInt());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_signal_strength_info()
                            ->set_rssnr(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["rssnr"]
                                    .asInt());
                        cellInfo->mutable_nb1_ntn_cell_info()
                            ->mutable_nb1_ntn_signal_strength_info()
                            ->set_rssi(
                                requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["rssi"]
                                    .asInt());
                        break;
                    }
...
JsonData TelUtil::readEcallOperatingModeRespFromJsonFile(
    int phoneId, telStub::GetECallOperatingModeReply *response) {
    LOG(DEBUG, __FUNCTION__);
    JsonData data;
    if (ErrorCode::SUCCESS
        != readJsonData(phoneId, TEL_PHONE_MANAGER, "requestECallOperatingMode", data)) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return data;
    }
    if (data.status == telux::common::Status::SUCCESS) {
        int ecallMode
            = data.stateRootObj[TEL_PHONE_MANAGER]["eCallOperatingMode"]["ecallMode"].asInt();
...
JsonData TelUtil::readResetWwanRespFromJsonFile(telStub::ResetWwanReply *response) {
    ...
    if (error == ErrorCode::SUCCESS && event.operating_mode() == telStub::OperatingMode::ONLINE) {
        if (ErrorCode::SUCCESS
            != readJsonData(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "resetWwan", data)) {
            LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
            return data;
        }
        if (data.status == telux::common::Status::SUCCESS) {
...
JsonData TelUtil::readRequestOperatorInfoRespFromJsonFile(
    int phoneId, telStub::RequestOperatorInfoReply *response) {
    LOG(DEBUG, __FUNCTION__);
    ...
    if (error == ErrorCode::SUCCESS && event.operating_mode() == telStub::OperatingMode::ONLINE) {
        if (ErrorCode::SUCCESS
            != readJsonData(phoneId, TEL_PHONE_MANAGER, "requestOperatorInfo", data)) {
            LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
            return data;
        }
        if (data.status == telux::common::Status::SUCCESS) {
            std::string operatorLongName
                = data.stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["longName"].asString();
            std::string operatorShortName
                = data.stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["shortName"].asString();
            std::string plmn
                = data.stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["plmn"].asString();
            bool home = data.stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["home"].asBool();
...
telux::common::ErrorCode TelUtil::readSignalStrengthEventFromJsonFile(
    int phoneId, telStub::SignalStrengthChangeEvent &event) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
        = readFromJsonFile(phoneId, TEL_PHONE_MANAGER, stateRootObj, jsonfilename);
    if (error != ErrorCode::SUCCESS) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return error;
    }
    ...
    // gsm signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_GSM) {
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->set_gsm_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmSign"
                                                                                           "alStren"
                                                                                           "gth"]
                .asInt());
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->set_gsm_bit_error_rate(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmBitE"
                                                                                           "rrorRat"
                                                                                           "e"]
                .asInt());
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->set_gsm_rssi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmRss"
                                                                                           "i"]
                .asInt());
    } else {
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->set_gsm_signal_strength(
    ...
    LOG(DEBUG, __FUNCTION__, " gsmSignalStrength:",
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->gsm_signal_strength(),
        " gsmBitErrorRate",
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->gsm_bit_error_rate(),
        " gsmRssi",
        event.mutable_signal_strength()->mutable_gsm_signal_strength_info()->gsm_rssi());

    // lte signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_LTE) {
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteSign"
                                                                                           "alStren"
                                                                                           "gth"]
                .asInt());
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_rsrp(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRsr"
                                                                                           "p"]
                .asInt());
        ...
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_rssnr(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRssn"
                                                                                           "r"]
                .asInt());
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_cqi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteCqi"]
                .asInt());
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_timing_advance(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["timingA"
                                                                                           "dvance"]
                .asInt());
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_rssi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRss"
                                                                                           "i"]
                .asInt());
    } else {
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->set_lte_signal_strength(
    ...
    LOG(DEBUG, __FUNCTION__, " lteSignalStrength: ",
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->lte_signal_strength(),
        " lteRsrp: ",
        ...
        " lteCqi: ", event.mutable_signal_strength()->mutable_lte_signal_strength_info()->lte_cqi(),
        " timingAdvance: ",
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->timing_advance(),
        " lteRssi: ",
        event.mutable_signal_strength()->mutable_lte_signal_strength_info()->lte_rssi());

    // wcdma signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_UMTS) {
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["signa"
                                                                                             "lStre"
                                                                                             "ngth"]
                .asInt());
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_bit_error_rate(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["bitEr"
                                                                                             "rorRa"
                                                                                             "te"]
                .asInt());
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_ecio(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["ecio"]
                .asInt());
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_rscp(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["rscp"]
                .asInt());
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_rssi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["rssi"]
                .asInt());
    } else {
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->set_signal_strength(
            INVALID_SIGNAL_STRENGTH_VALUE);
    ...
    LOG(DEBUG, __FUNCTION__, " wcdmaSignalStrength: ",
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->signal_strength(),
        " bitErrorRate: ",
        event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->bit_error_rate(),
        " ecio: ", event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->ecio(),
        " rscp: ", event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->rscp(),
        " rssi: ", event.mutable_signal_strength()->mutable_wcdma_signal_strength_info()->rssi());

    // nr5g signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_NR5G) {
        event.mutable_signal_strength()->mutable_nr5g_signal_strength_info()->set_rsrp(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nr5gSignalStrengthInfo"]["rsrp"]
                .asInt());
        event.mutable_signal_strength()->mutable_nr5g_signal_strength_info()->set_rsrq(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nr5gSignalStrengthInfo"]["rsrq"]
                .asInt());
        event.mutable_signal_strength()->mutable_nr5g_signal_strength_info()->set_rssnr(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nr5gSignalStrengthInfo"]["rssnr"]
                .asInt());
    } else {
        event.mutable_signal_strength()->mutable_nr5g_signal_strength_info()->set_rsrp(
            INVALID_SIGNAL_STRENGTH_VALUE);
    ...
    // nb1 ntn signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_NB1_NTN) {
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_signal_strength(
        ...
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_rsrp(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rsr"
                                                                                              "p"]
                .asInt());
        ...
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_rssnr(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rssn"
                                                                                              "r"]
                .asInt());
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_rssi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rss"
                                                                                              "i"]
                .asInt());
    } else {
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->set_signal_strength(
    ...
    LOG(DEBUG, __FUNCTION__, " nb1NtnSignalStrength: ",
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->signal_strength(),
        " rsrp: ", event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->rsrp(),
        " rssnr: ",
        event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->rssnr(),
        " rsrq: ", event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->rsrq(),
        " rssi: ", event.mutable_signal_strength()->mutable_nb1_ntn_signal_strength_info()->rssi());
    event.set_phone_id(phoneId);
    return error;
}

telux::common::ErrorCode TelUtil::readCellInfoListEventFromJsonFile(
    int phoneId, telStub::CellInfoListEvent &cellInfoListEvent) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
    ...
    if (error == ErrorCode::SUCCESS && event.operating_mode() == telStub::OperatingMode::ONLINE) {
        ...
        for (int i = 0; i < newCellCount; i++) {
            ...
            Json::Value requestedCell = stateRootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i];
            // whether any cell registered
            int isRegistered = requestedCell["registered"].asInt();
            cellInfo->mutable_cell_type()->set_registered(isRegistered);
            telStub::CellInfo_CellType cellType
            ...
            switch (cellType) {
                case telStub::CellInfo_CellType_GSM: {
                    ...
                    cellInfo->mutable_gsm_cell_info()
                        ->mutable_gsm_signal_strength_info()
                        ->set_gsm_signal_strength(
                            requestedCell["gsmCellInfo"]["gsmSignalStrengthInfo"]["gsmSignalStrengt"
                                                                                  "h"]
                                .asInt());
                    cellInfo->mutable_gsm_cell_info()
                        ->mutable_gsm_signal_strength_info()
                        ->set_gsm_bit_error_rate(
                            requestedCell["gsmCellInfo"]["gsmSignalStrengthInfo"]["gsmBitErrorRate"]
                                .asInt());
                    cellInfo->mutable_gsm_cell_info()
                        ->mutable_gsm_signal_strength_info()
                        ->set_gsm_rssi(
                ...
                case telStub::CellInfo_CellType_LTE: {
                    ...
                    cellInfo->mutable_lte_cell_info()
                        ->mutable_lte_signal_strength_info()
                        ->set_lte_signal_strength(
                            requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteSignalStrengt"
                                                                                  "h"]
                                .asInt());
                    cellInfo->mutable_lte_cell_info()
                        ->mutable_lte_signal_strength_info()
                    ...
                    cellInfo->mutable_lte_cell_info()
                        ->mutable_lte_signal_strength_info()
                        ->set_lte_cqi(
                            requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["lteCqi"].asInt());
                    cellInfo->mutable_lte_cell_info()
                        ->mutable_lte_signal_strength_info()
                        ->set_timing_advance(
                            requestedCell["lteCellInfo"]["lteSignalStrengthInfo"]["timingAdvance"]
                                .asInt());
                    cellInfo->mutable_lte_cell_info()
                        ->mutable_lte_signal_strength_info()
                        ->set_lte_rssi(
                ...
                case telStub::CellInfo_CellType_WCDMA: {
                    ...
                    cellInfo->mutable_wcdma_cell_info()
                        ->mutable_wcdma_signal_strength_info()
                        ->set_signal_strength(requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthIn"
                                                                             "fo"]["signalStrength"]
                                                  .asInt());
                    cellInfo->mutable_wcdma_cell_info()
                        ->mutable_wcdma_signal_strength_info()
                        ->set_bit_error_rate(requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInf"
                                                                            "o"]["bitErrorRate"]
                                                 .asInt());
                    cellInfo->mutable_wcdma_cell_info()
                        ->mutable_wcdma_signal_strength_info()
                        ->set_ecio(requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["ecio"]
                                       .asInt());
                    cellInfo->mutable_wcdma_cell_info()
                        ->mutable_wcdma_signal_strength_info()
                        ->set_rscp(requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["rscp"]
                                       .asInt());
                    cellInfo->mutable_wcdma_cell_info()
                        ->mutable_wcdma_signal_strength_info()
                        ->set_rssi(requestedCell["wcdmaCellInfo"]["wcdmaSignalStrengthInfo"]["rssi"]
                                       .asInt());
                    break;
                }
                case telStub::CellInfo_CellType_NR5G: {
                    ...
                    cellInfo->mutable_nr5g_cell_info()->mutable_nr5g_cell_identity()->set_arfcn(
                        requestedCell["nr5gCellInfo"]["nr5gCellIdentity"]["arfcn"].asInt());
                    // signal strength
                    cellInfo->mutable_nr5g_cell_info()->mutable_nr5g_signal_strength_info()->set_rsrp(
                        requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rsrp"].asInt());
                    cellInfo->mutable_nr5g_cell_info()->mutable_nr5g_signal_strength_info()->set_rsrq(
                        requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rsrq"].asInt());
                    cellInfo->mutable_nr5g_cell_info()
                        ->mutable_nr5g_signal_strength_info()
                        ->set_rssnr(requestedCell["nr5gCellInfo"]["nr5gSignalStrengthInfo"]["rssnr"]
                                        .asInt());
                    break;
                }
                case telStub::CellInfo_CellType_NB1_NTN: {
                    ...
                    cellInfo->mutable_nb1_ntn_cell_info()
                        ->mutable_nb1_ntn_signal_strength_info()
                        ->set_signal_strength(
                            requestedCell["nb1NtnCellInfo"]["nb1NtnSignalStrengthInfo"]["signalStre"
                                                                                        "ngth"]
                                .asInt());
                    cellInfo->mutable_nb1_ntn_cell_info()
                        ->mutable_nb1_ntn_signal_strength_info()
...
telux::common::ErrorCode TelUtil::readVoiceServiceStateEventFromJsonFile(
    ...
    telStub::VoiceServiceState voiceServiceState = static_cast<telStub::VoiceServiceState>(
        stateRootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceState"].asInt());
    ...
    telStub::VoiceServiceDenialCause voiceServiceDenialCause
        = static_cast<telStub::VoiceServiceDenialCause>(
            stateRootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceDenialCause"]
                .asInt());
    LOG(DEBUG, __FUNCTION__,
        " VoiceServiceDenialCause is :", static_cast<int>(voiceServiceDenialCause));
...
telux::common::ErrorCode TelUtil::readOperatingModeEventFromJsonFile(
    ...
    std::string jsonfilename;
    telux::common::ErrorCode error
        = readFromJsonFile(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, stateRootObj, jsonfilename);
    if (error != ErrorCode::SUCCESS) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return error;
    }
    int opMode = stateRootObj[TEL_PHONE_MANAGER]["operatingModeInfo"]["operatingMode"].asInt();
    telStub::OperatingMode operatingMode = static_cast<telStub::OperatingMode>(opMode);
...
telux::common::ErrorCode TelUtil::readServiceStateEventFromJsonFile(
...
telux::common::ErrorCode TelUtil::readVoiceRadioTechnologyEventFromJsonFile(
...
telux::common::ErrorCode TelUtil::readEcallOperatingModeEventFromJsonFile(
...
telux::common::ErrorCode TelUtil::readOperatorInfoEventFromJsonFile(
    int phoneId, telStub::OperatorInfoEvent &event) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
    ...
    std::string longName
        = stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["longName"].asString();
    std::string shortName
        = stateRootObj[TEL_PHONE_MANAGER]["operatorNameInfo"]["shortName"].asString();
...
telux::common::ErrorCode TelUtil::readSignalStrengthFromJsonFile(
    ...
    LOG(DEBUG, __FUNCTION__, " gsmSignalStrength: ",
        ...
        " gsmRssi: ", signalStrength.mutable_gsm_signal_strength_info()->gsm_rssi());

    // lte signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_LTE) {
        signalStrength.mutable_lte_signal_strength_info()->set_lte_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteSign"
                                                                                           "alStren"
                                                                                           "gth"]
                .asInt());
    ...
    LOG(DEBUG, __FUNCTION__, " lteSignalStrength: ",
        signalStrength.mutable_lte_signal_strength_info()->lte_signal_strength(),
        " lteRsrp: ", signalStrength.mutable_lte_signal_strength_info()->lte_rsrp(),
        " lteRsrq: ", signalStrength.mutable_lte_signal_strength_info()->lte_rsrq(),
        " lteRssnr: ", signalStrength.mutable_lte_signal_strength_info()->lte_rssnr(),
        " lteCqi: ", signalStrength.mutable_lte_signal_strength_info()->lte_cqi(),
        " timingAdvance: ", signalStrength.mutable_lte_signal_strength_info()->timing_advance(),
        " lteRssi: ", signalStrength.mutable_lte_signal_strength_info()->lte_rssi());

    // wcdma signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_UMTS) {
        signalStrength.mutable_wcdma_signal_strength_info()->set_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["signa"
                                                                                             "lStre"
                                                                                             "ngth"]
                .asInt());
        signalStrength.mutable_wcdma_signal_strength_info()->set_bit_error_rate(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["bitEr"
                                                                                             "rorRa"
                                                                                             "te"]
                .asInt());
        signalStrength.mutable_wcdma_signal_strength_info()->set_ecio(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["ecio"]
                .asInt());
        signalStrength.mutable_wcdma_signal_strength_info()->set_rscp(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["rscp"]
                .asInt());
        signalStrength.mutable_wcdma_signal_strength_info()->set_rssi(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["rssi"]
                .asInt());
    } else {
        signalStrength.mutable_wcdma_signal_strength_info()->set_signal_strength(
    ...
    LOG(DEBUG, __FUNCTION__, " wcdmaSignalStrength: ",
        ...
        " bitErrorRate: ", signalStrength.mutable_wcdma_signal_strength_info()->bit_error_rate(),
        " ecio: ", signalStrength.mutable_wcdma_signal_strength_info()->ecio(),
        " rscp: ", signalStrength.mutable_wcdma_signal_strength_info()->rscp(),
        " rssi: ", signalStrength.mutable_wcdma_signal_strength_info()->rssi());
    ...
    LOG(DEBUG, __FUNCTION__,
        " nr5gRsrp: ", signalStrength.mutable_nr5g_signal_strength_info()->rsrp(),
        " nr5gRsrq: ", signalStrength.mutable_nr5g_signal_strength_info()->rsrq(),
        " nr5gRssnr: ", signalStrength.mutable_nr5g_signal_strength_info()->rssnr());
    // NB1 NTN signal strength
    if (servingRat == telStub::RadioTechnology::RADIO_TECH_NB1_NTN) {
        signalStrength.mutable_nb1_ntn_signal_strength_info()->set_signal_strength(
            stateRootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]
                        ["signalStrength"]
                            .asInt());
    ...
    LOG(DEBUG, __FUNCTION__, " nb1NtnSignalStrength: ",
        signalStrength.mutable_nb1_ntn_signal_strength_info()->signal_strength(),
        " nb1NtnRsrp: ", signalStrength.mutable_nb1_ntn_signal_strength_info()->rsrp(),
        " nb1NtnRsrq: ", signalStrength.mutable_nb1_ntn_signal_strength_info()->rsrq(),
        " nb1NtnRssnr: ", signalStrength.mutable_nb1_ntn_signal_strength_info()->rssnr(),
        " nb1NtnRssi: ", signalStrength.mutable_nb1_ntn_signal_strength_info()->rssi());
    return error;
}

telux::common::ErrorCode TelUtil::readServiceStateFromJsonFile(
...
telux::common::ErrorCode TelUtil::readVoiceRadioTechnologyFromJsonFile(
...
telux::common::ErrorCode TelUtil::readSystemInfoFromJsonFile(int phoneId,
    ...
    std::string jsonfilename;
    telux::common::ErrorCode error
        = readFromJsonFile(phoneId, TEL_SERVING_MANAGER, stateRootObj, jsonfilename);
    if (error != ErrorCode::SUCCESS) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return error;
    }
...
telux::common::ErrorCode TelUtil::readOperatingModeFromJsonFile(telStub::OperatingMode &mode) {
    ...
    std::string jsonfilename;
    telux::common::ErrorCode error
        = readFromJsonFile(DEFAULT_SLOT_ID, TEL_SERVING_MANAGER, stateRootObj, jsonfilename);
    if (error != ErrorCode::SUCCESS) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return error;
    }
    int operatingMode
        = stateRootObj[TEL_PHONE_MANAGER]["operatingModeInfo"]["operatingMode"].asInt();
    mode = static_cast<telStub::OperatingMode>(operatingMode);
    LOG(DEBUG, __FUNCTION__, " OperatingMode: ", operatingMode);
    return error;
}

telux::common::ErrorCode TelUtil::readRatPreferenceFromJsonFile(
    int phoneId, std::vector<int> &ratData) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
...
telux::common::ErrorCode TelUtil::writeSignalStrengthToJsonFile(
    int phoneId, telStub::SignalStrengthChangeEvent &event) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value rootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
        = readFromJsonFile(phoneId, TEL_PHONE_MANAGER, rootObj, jsonfilename);
    if (error != ErrorCode::SUCCESS) {
        LOG(ERROR, __FUNCTION__, " Reading JSON File failed");
        return error;
    }
...
telux::common::ErrorCode TelUtil::writeVoiceServiceStateToJsonFile(
    int phoneId, telStub::VoiceServiceStateEvent &event) {
    LOG(DEBUG, __FUNCTION__);
    Json::Value stateRootObj;
    std::string jsonfilename;
    ...
    stateRootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceState"]
    ...
    LOG(DEBUG, __FUNCTION__,
        "Writing VoiceServiceState:", event.voice_service_state_info().voice_service_state(),
...
telux::common::ErrorCode TelUtil::writeOperatingModeToJsonFile(telStub::OperatingModeEvent &event) {
    ...
    stateRootObj[TEL_PHONE_MANAGER]["operatingModeInfo"]["operatingMode"] = event.operating_mode();
    LOG(DEBUG, __FUNCTION__, " Operating Mode:", static_cast<int>(event.operating_mode()));
    return JsonParser::writeToJsonFile(stateRootObj, jsonfilename);
}

telux::common::ErrorCode TelUtil::writeServiceStateToJsonFile(
    int phoneId, telStub::ServiceStateChangeEvent &event) {
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
    ...
    stateRootObj[TEL_PHONE_MANAGER]["serviceStateInfo"]["serviceState"] = event.service_state();
    LOG(DEBUG, __FUNCTION__, " Service State:", static_cast<int>(event.service_state()));
    return JsonParser::writeToJsonFile(stateRootObj, jsonfilename);
}

telux::common::ErrorCode TelUtil::writeVoiceRadioTechnologyToJsonFile(
    int phoneId, telStub::VoiceRadioTechnologyChangeEvent &event) {
    Json::Value stateRootObj;
    std::string jsonfilename;
    telux::common::ErrorCode error
    ...
    stateRootObj[TEL_PHONE_MANAGER]["voiceRatInfo"]["rat"] = event.radio_technology();
...
telux::common::ErrorCode TelUtil::writeSystemInfoToJsonFile(int phoneId,
    ...
    LOG(DEBUG, __FUNCTION__, " RAT:", static_cast<int>(servingRat),
        " Domain: ", static_cast<int>(servingDomain));
    return JsonParser::writeToJsonFile(stateRootObj, jsonfilename);
}

JsonData TelUtil::writeOperatingModeToJsonFileAndReply(
    telStub::OperatingMode mode, telStub::SetOperatingModeReply *response) {
    LOG(DEBUG, __FUNCTION__);
    JsonData data;
    std::string stateJsonPath = "";
    telux::common::ErrorCode error
        = readJsonData(DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "setOperatingMode", data, stateJsonPath);
    do {
        if (error == ErrorCode::SUCCESS) {
            if (data.status == telux::common::Status::SUCCESS) {
...
telux::common::ErrorCode TelUtil::writeSetCellInfoListRateToJsonFileAndReply(
    int cellInfoListRate, telStub::SetCellInfoListRateReply *response) {

    JsonData data;
    std::string stateJsonPath      = "";
    telux::common::ErrorCode error = readJsonData(
        DEFAULT_SLOT_ID, TEL_PHONE_MANAGER, "setCellInfoListRate", data, stateJsonPath);
...
telux::common::ErrorCode TelUtil::writeSetRadioPowerToJsonFileAndReply(
    int phoneId, int enable, telStub::SetRadioPowerReply *response) {
    JsonData data;
    std::string stateJsonPath = "";
    telux::common::ErrorCode error
        = readJsonData(phoneId, TEL_PHONE_MANAGER, "setRadioPower", data, stateJsonPath);
    if (error == ErrorCode::SUCCESS) {
        if (data.status == telux::common::Status::SUCCESS) {
...
telux::common::ErrorCode TelUtil::writeEcallOperatingModeToJsonFileAndReply(int phoneId,
    ...
    if ((error == ErrorCode::SUCCESS)
        && (event.operating_mode() == telStub::OperatingMode::ONLINE)) {
        error = readJsonData(
            phoneId, TEL_PHONE_MANAGER, "setECallOperatingMode", data, stateJsonPath);
        if (error == ErrorCode::SUCCESS) {
            if (data.status == telux::common::Status::SUCCESS) {
                ...
                if (ecallMode < (static_cast<int>(telStub::ECallMode::NORMAL))
                    ...
                    response->set_error(
                        static_cast<commonStub::ErrorCode>(commonStub::ErrorCode::NOT_SUPPORTED));
                } else {
                    ...
                    data.error = JsonParser::writeToJsonFile(data.stateRootObj, stateJsonPath);
                    LOG(DEBUG, __FUNCTION__, " ecallMode: ", ecallMode,
...
telux::common::ErrorCode TelUtil::writeConfigureSignalStrengthToJsonFileAndReply(int phoneId,
    ...
    telux::common::ErrorCode error
        = readJsonData(phoneId, TEL_PHONE_MANAGER, "configureSignalStrength", data, stateJsonPath);
    if (error == ErrorCode::SUCCESS) {
        if (data.status == telux::common::Status::SUCCESS) {
            int currentCount = 0;
            for (unsigned int i = 0; i < signalStrengthConfig.size(); i++) {
                ...
                currentCount
                    = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthInfo"].size();
                ...
                switch (signalStrengthConfig[i].config_type()) {
                    ...
                    case telStub::SignalStrengthConfigType::THRESHOLD:
                        newconfig["lowerThreshold"]
                            = signalStrengthConfig[i].mutable_threshold()->lower_range_threshold();
                        newconfig["upperThreshold"]
                            = signalStrengthConfig[i].mutable_threshold()->upper_range_threshold();
                        break;
                    default:
                        break;
                }
                ...
                for (int j = 0; j < currentCount; j++) {
                    ...
                    if ((data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthInfo"][j]
                                          ["radioSignalType"])
                        == newconfig["radioSignalType"]) {
                        LOG(DEBUG, __FUNCTION__, " Matched RAT");
                        data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthInfo"][j]
                            = newconfig;
                        ratFound = true;
                        break;
                    }
                ...
                data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthInfo"][currentCount++]
                    = newconfig;
            }
            JsonParser::writeToJsonFile(data.stateRootObj, stateJsonPath);
        }
...
telux::common::ErrorCode TelUtil::writeConfigureSignalStrengthExToJsonFileAndReply(int phoneId,
    ...
    if (error == ErrorCode::SUCCESS) {
        if (data.status == telux::common::Status::SUCCESS) {
            int currentCount = 0;
            LOG(DEBUG, __FUNCTION__,
                " signal strength config size = ", signalStrengthConfigEx.size());
            for (unsigned int idx = 0; idx < signalStrengthConfigEx.size(); idx++) {
                Json::Value newconfig;
                currentCount = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInfo"]
                                                ["configureSignalStrengthExInfoList"]
                                                    .size();
                ...
                for (int cdIdx = 0; cdIdx < signalStrengthConfigEx[idx].sig_config_data().size();
                     cdIdx++) {
                    newconfig["sigMeasType"] = signalStrengthConfigEx[idx]
                                                   .mutable_sig_config_data(cdIdx)
                                                   ->sig_meas_type();
                    for (int cfIdx = 0; cfIdx < signalStrengthConfigEx[idx].config_types().size();
                         cfIdx++) {
                        if (signalStrengthConfigEx[idx].config_types(cfIdx)
                            == telStub::SignalStrengthConfigExType::EX_DELTA) {
                            newconfig["delta"] = signalStrengthConfigEx[idx]
                                                     .mutable_sig_config_data(cdIdx)
                                                     ->delta();
                        }
                        if (signalStrengthConfigEx[idx].config_types(cfIdx)
                            == telStub::SignalStrengthConfigExType::EX_THRESHOLD) {
                            for (int arrIdx = 0; arrIdx < signalStrengthConfigEx[idx]
                                                              .mutable_sig_config_data(cdIdx)
                                                              ->mutable_elements()
                                                              ->threshold_list()
                                                              .size();
                                 arrIdx++) {
                                if (signalStrengthConfigEx[idx]
                                        .mutable_sig_config_data(cdIdx)
                                        ->mutable_elements()
                                        ->threshold_list(arrIdx)) {
                                    newconfig["thresholdList"][arrIdx]
                                        = signalStrengthConfigEx[idx]
                                              .mutable_sig_config_data(cdIdx)
                                              ->mutable_elements()
                                              ->threshold_list(arrIdx);
                                }
                        ...
                        if (signalStrengthConfigEx[idx].config_types(cfIdx)
                            ...
                            newconfig["hysteresisDb"] = signalStrengthConfigEx[idx]
                                                            .mutable_sig_config_data(cdIdx)
                                                            ->mutable_elements()
                                                            ->hysteresis_db();
                        }
                    ...
                    for (int j = 0; j < currentCount; j++) {
                        ...
                        if ((data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInfo"]
                                              ["configureSignalStrengthExInfoList"][j]["radioTech"])
                                == newconfig["radioTech"]
                            && (data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInf"
                                                                     "o"]["configureSignalStrengthE"
                                                                          "xInfoList"][j]["sigMeasT"
                                                                                          "ype"])
                    ...
                    data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInfo"]
                                     ["configureSignalStrengthExInfoList"][currentCount++]
                        = newconfig;
                }
            }
            data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInfo"]["hysteresisMs"]
                = hysTimer;
            JsonParser::writeToJsonFile(data.stateRootObj, stateJsonPath);
        }
    } else {
...
telux::common::ErrorCode TelUtil::writeSignalStrengthToJsonFile(
    std::vector<std::string> params, int &phoneId, bool &notify) {
    LOG(DEBUG, __FUNCTION__);
    telux::common::ErrorCode errorCode = telux::common::ErrorCode::INTERNAL_ERR;
    try {
        // Read string to get slotId
        std::string token
            = telux::common::EventParserUtil::getNextToken(params[0], DEFAULT_DELIMITER);
        ...
        Json::Value rootObj;
        std::string jsonfilename
            = (phoneId == SLOT_1) ? PHONE_JSON_STATE_PATH1 : PHONE_JSON_STATE_PATH2;
        ...
        std::string stateJsonPath = (phoneId == SLOT_1) ? "tel/IServingSystemManagerStateSlot1"
                                                        : "tel/IServingSystemManagerStateSlot2";
        int servingRat            = std::stoi(CommonUtils::readSystemDataValue(
            stateJsonPath, "", {TEL_SERVING_MANAGER, "ServingSystemInfo", "rat"}));
        ...
        for (int index = 1; index <= signalStrengthInfoCount; index++) {
            std::string rat
                = telux::common::EventParserUtil::getNextToken(params[index], DEFAULT_DELIMITER);
            LOG(DEBUG, __FUNCTION__, " RAT Type is: ", rat);
            if (rat == "GSM") {
                token = telux::common::EventParserUtil::getNextToken(
                    params[index], DEFAULT_DELIMITER);
                ...
                LOG(DEBUG, __FUNCTION__, " signalStrength: ", signalStrength,
                ...
                if (servingRat == static_cast<int>(telStub::RadioTechnology::RADIO_TECH_GSM)) {
                    int oldValue = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                          ["gsmSignalStrengthInfo"]["gsmSignalStrength"]
                                              .asInt();
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmSigna"
                                                                                          "lStrengt"
                                                                                          "h"]
                    = signalStrength;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmBitEr"
                                                                                          "rorRate"]
                    = bitErrorRate;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["gsmSignalStrengthInfo"]["gsmRssi"]
                    = rssi;
                ...
                if (servingRat == static_cast<int>(telStub::RadioTechnology::RADIO_TECH_UMTS)) {
                    int oldValue
                        = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInf"
                                                                           "o"]["rssi"]
                              .asInt();
                    notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                    ...
                    if (!notify) {  // if any one field changes, need to notify,
                        ...
                        oldValue
                            = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrength"
                                                                               "Info"]["ecio"]
                                  .asInt();
                        notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                            telStub::RadioTechnology::RADIO_TECH_UMTS,
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["signal"
                                                                                            "Streng"
                                                                                            "th"]
                    = signalStrength;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["bitErr"
                                                                                            "orRat"
                                                                                            "e"]
                    = bitErrorRate;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["wcdmaSignalStrengthInfo"]["ecio"]
                ...
                LOG(DEBUG, __FUNCTION__, " signalStrength: ", signalStrength, " rsrp: ", rsrp,
                    " rsrq: ", rsrq, " rssnr: ", rssnr, " cqi: ", cqi,
                    " timingAdvance: ", timingAdvance, " rssi: ", rssi);

                if (servingRat == static_cast<int>(telStub::RadioTechnology::RADIO_TECH_LTE)) {
                    int oldValue = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                          ["lteSignalStrengthInfo"]["lteRssi"]
                                              .asInt();
                    notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                    ...
                    if (!notify) {  // if any one field changes, need to notify
                                    // skip next field check
                        oldValue
                            = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthIn"
                                                                               "fo"]["lteRsrp"]
                                  .asInt();
                        notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                            telStub::RadioTechnology::RADIO_TECH_LTE,
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteSigna"
                                                                                          "lStrengt"
                                                                                          "h"]
                    = signalStrength;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRsrp"]
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRsrq"]
                    = rsrq;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRssn"
                                                                                          "r"]
                    = rssnr;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteCqi"]
                    = cqi;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["timingAd"
                                                                                          "vance"]
                    = timingAdvance;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["lteSignalStrengthInfo"]["lteRssi"]
                    = rssi;
                ...
                if (servingRat == static_cast<int>(telStub::RadioTechnology::RADIO_TECH_NR5G)) {
                    ...
                    if (!notify) {  // if any one field changes for particular RAT, need to notify
                                    // skip next field check
                        oldValue
                            = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nr5gSignalStrengthI"
                                                                               "nfo"]["rsrq"]
                                  .asInt();
                        notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                            telStub::RadioTechnology::RADIO_TECH_NR5G,
                ...
                if (servingRat == static_cast<int>(telStub::RadioTechnology::RADIO_TECH_NB1_NTN)) {
                    int oldValue
                        = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInf"
                                                                           "o"]["signalStrength"]
                              .asInt();
                    notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                    ...
                    if (!notify) {  // if any one field changes, need to notify
                                    // skip next field check
                        oldValue
                            = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengt"
                                                                               "hInfo"]["rsrp"]
                                  .asInt();
                        notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                            telStub::RadioTechnology::RADIO_TECH_NB1_NTN,
                        ...
                        if (!notify) {  // if any one field changes for particular RAT, need to
                            // notify, skip next field check
                            oldValue = rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]
                                              ["nb1NtnSignalStrengthInfo"]["rssnr"]
                                                  .asInt();
                            notify = checkSignalStrengthCriteriaAndNotify(phoneId,
                                telStub::RadioTechnology::RADIO_TECH_NB1_NTN,
                                telStub::SignalStrengthMeasurementType::SNR, oldValue, rssnr);
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["signa"
                                                                                             "lStre"
                                                                                             "ngth"]
                    = signalStrength;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rsrp"]
                ...
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rsrq"]
                    = rsrq;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rssn"
                                                                                             "r"]
                    = rssnr;
                rootObj[TEL_PHONE_MANAGER]["signalStrengthInfo"]["nb1NtnSignalStrengthInfo"]["rssi"]
                    = rssi;
...
telux::common::ErrorCode TelUtil::writeCellInfoListToJsonFile(
    std::vector<std::string> params, int &phoneId) {
    Json::Value rootObj;
    std::string jsonfilename = "";
    try {
        // Read string to get slotId
        ...
        for (int i = 1; i <= newCellCount; i++) {
            ...
            if (cell < (static_cast<int>(::telStub::CellInfo_CellType::CellInfo_CellType_GSM))
                || cell > (static_cast<int>(
                       ::telStub::CellInfo_CellType::CellInfo_CellType_NB1_NTN))) {
            ...
            switch (cellType) {
                case ::telStub::CellInfo_CellType::CellInfo_CellType_GSM: {
                    ...
                    LOG(DEBUG, __FUNCTION__, " mcc:", mcc, " mnc:", mnc, " lac:", lac, " cid:", cid,
                        " arfcn:", arfcn, " bsic:", bsic, " signalStrength:", signalStrength,
                        " bitErrorRate:", bitErrorRate, " rssi:", rssi);
                    ...
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                        ...
                        = cid;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                           ["gsmCellIdentity"]["arfcn"]
                        = arfcn;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                           ["gsmCellIdentity"]["bsic"]
                        = bsic;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                           ["gsmSignalStrengthInfo"]["gsmSignalStrength"]
                        = signalStrength;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                           ["gsmSignalStrengthInfo"]["gsmBitErrorRate"]
                        = bitErrorRate;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["gsmCellInfo"]
                           ["gsmSignalStrengthInfo"]["gsmRssi"]
                        = rssi;
                    break;
                }
                case ::telStub::CellInfo_CellType::CellInfo_CellType_WCDMA: {
                    ...
                    int rssi         = std::stoi(token);
                    LOG(DEBUG, __FUNCTION__, " mcc:", mcc, " mnc:", mnc, " lac:", lac, " cid:", cid,
                        " psc:", psc, " uarfcn:", uarfcn, " signalStrength:", signalStrength,
                        " bitErrorRate:", bitErrorRate, " ecio:", ecio, "rscp:", rscp,
                        "rssi:", rssi);

                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["mcc"]
                        = mcc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["mnc"]
                        = mnc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["lac"]
                        = lac;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["cid"]
                        = cid;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["psc"]
                        = psc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaCellIdentity"]["uarfcn"]
                        = uarfcn;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaSignalStrengthInfo"]["signalStrength"]
                        = signalStrength;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                        ...
                        = bitErrorRate;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaSignalStrengthInfo"]["ecio"]
                        = ecio;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaSignalStrengthInfo"]["rscp"]
                        = rscp;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["wcdmaCellInfo"]
                           ["wcdmaSignalStrengthInfo"]["rssi"]
                        = rssi;
                    break;
                }
                case ::telStub::CellInfo_CellType::CellInfo_CellType_LTE: {
                    ...
                    token             = EventParserUtil::getNextToken(params[i], DEFAULT_DELIMITER);
                    int rssi          = std::stoi(token);
                    LOG(DEBUG, __FUNCTION__, " mcc:", mcc, " mnc:", mnc, " ci:", ci, " pci:", pci,
                        " tac:", tac, " earfcn:", earfcn, " signalStrength:", signalStrength,
                    ...
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                        ...
                        = tac;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteCellIdentity"]["earfcn"]
                        = earfcn;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["lteSignalStrength"]
                        = signalStrength;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["lteRsrp"]
                        = lteRsrp;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["lteRsrq"]
                        = lteRsrq;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["lteRssnr"]
                        = lteRssnr;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["lteCqi"]
                        = lteCqi;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["lteCellInfo"]
                           ["lteSignalStrengthInfo"]["timingAdvance"]
                        = timingAdvance;
                ...
                case ::telStub::CellInfo_CellType::CellInfo_CellType_NR5G: {
                    ...
                    LOG(DEBUG, __FUNCTION__, " mcc:", mcc, " mnc:", mnc, " ci:", ci, " pci:", pci,
                        " tac:", tac, " arfcn:", arfcn, " rsrp:", rsrp, "rsrq:", rsrq,
                        "rssnr:", rssnr);

                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["mcc"]
                        = mcc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["mnc"]
                        = mnc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["ci"]
                        = ci;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["pci"]
                        = pci;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["tac"]
                        = tac;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gCellIdentity"]["arfcn"]
                        = arfcn;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gSignalStrengthInfo"]["rsrp"]
                        = rsrp;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gSignalStrengthInfo"]["rsrq"]
                        = rsrq;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nr5gCellInfo"]
                           ["nr5gSignalStrengthInfo"]["rssnr"]
                        = rssnr;
                ...
                case ::telStub::CellInfo_CellType::CellInfo_CellType_NB1_NTN: {
                    ...
                    LOG(DEBUG, __FUNCTION__, " mcc:", mcc, " mnc:", mnc, " ci:", ci, " tac:", tac,
                        " earfcn:", earfcn, " signalStrength:", signalStrength, "rsrp:", rsrp,
                        "rsrq:", rsrq, "rssnr:", rssnr, "rssi:", rssi);

                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnCellIdentity"]["mcc"]
                        = mcc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnCellIdentity"]["mnc"]
                        = mnc;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnCellIdentity"]["ci"]
                        = ci;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnCellIdentity"]["tac"]
                        = tac;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnCellIdentity"]["earfcn"]
                        = earfcn;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnSignalStrengthInfo"]["signalStrength"]
                        = signalStrength;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnSignalStrengthInfo"]["rsrp"]
                        = rsrp;
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["nb1NtnCellInfo"]
                           ["nb1NtnSignalStrengthInfo"]["rsrq"]
                        = rsrq;
                ...
                default: {
                    rootObj[TEL_PHONE_MANAGER]["cellInfo"]["cellList"][i - 1]["registered"]
                        = 0;  // none of the cell is registered
...
telux::common::ErrorCode TelUtil::writeVoiceServiceStateToJsonFile(
    std::string eventParams, int &phoneId) {
    Json::Value rootObj;
    std::string jsonfilename = "";
    try {
        // Read string to get slotId
        ...
        rootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceState"]
            = voiceServiceState;
        rootObj[TEL_PHONE_MANAGER]["voiceServiceStateInfo"]["voiceServiceDenialCause"]
            = voiceServiceDenialCause;
        ...
        LOG(DEBUG, __FUNCTION__, " VoiceServiceState:", voiceServiceState,
            " VoiceServiceDenialCause:", voiceServiceDenialCause, " RadioTech:", radioTech);
    } catch (exception const &ex) {
        LOG(ERROR, __FUNCTION__, " Exception Occured: ", ex.what());
        return telux::common::ErrorCode::GENERIC_FAILURE;
    }
...
telux::common::ErrorCode TelUtil::writeOperatingModeToJsonFile(
    std::string eventParams, int &phoneId) {
    std::string token = EventParserUtil::getNextToken(eventParams, DEFAULT_DELIMITER);
    Json::Value rootObj;
...
telux::common::ErrorCode TelUtil::writeEcallOperatingModeToJsonFile(
    std::string eventParams, int &phoneId) {
...
telux::common::ErrorCode TelUtil::writeOperatorInfoToJsonFile(
    std::string eventParams, int &phoneId) {
    Json::Value rootObj;
    std::string jsonfilename = "";
    try {
...
telStub::SignalStrengthChangeEvent TelUtil::createSignalStrengthEvent(
    int phoneId, telStub::SignalStrength &strength) {
    LOG(DEBUG, __FUNCTION__);
    ...
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_gsm_signal_strength_info()
        ->set_gsm_signal_strength(strength.gsm_signal_strength_info().gsm_signal_strength());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_gsm_signal_strength_info()
        ->set_gsm_bit_error_rate(strength.gsm_signal_strength_info().gsm_bit_error_rate());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_gsm_signal_strength_info()
        ->set_gsm_rssi(strength.gsm_signal_strength_info().gsm_rssi());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_wcdma_signal_strength_info()
        ->set_signal_strength(strength.wcdma_signal_strength_info().signal_strength());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_wcdma_signal_strength_info()
        ->set_bit_error_rate(strength.wcdma_signal_strength_info().bit_error_rate());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_wcdma_signal_strength_info()
        ->set_ecio(strength.wcdma_signal_strength_info().ecio());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_wcdma_signal_strength_info()
        ->set_rscp(strength.wcdma_signal_strength_info().rscp());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_wcdma_signal_strength_info()
        ->set_rssi(strength.wcdma_signal_strength_info().rssi());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_signal_strength(strength.lte_signal_strength_info().lte_signal_strength());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_rsrp(strength.lte_signal_strength_info().lte_rsrp());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_rsrq(strength.lte_signal_strength_info().lte_rsrq());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_rssnr(strength.lte_signal_strength_info().lte_rssnr());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_cqi(strength.lte_signal_strength_info().lte_cqi());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_timing_advance(strength.lte_signal_strength_info().timing_advance());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_lte_signal_strength_info()
        ->set_lte_rssi(strength.lte_signal_strength_info().lte_rssi());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nr5g_signal_strength_info()
        ->set_rsrp(strength.nr5g_signal_strength_info().rsrp());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nr5g_signal_strength_info()
        ->set_rsrq(strength.nr5g_signal_strength_info().rsrq());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nr5g_signal_strength_info()
        ->set_rssnr(strength.nr5g_signal_strength_info().rssnr());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nb1_ntn_signal_strength_info()
        ->set_signal_strength(strength.nb1_ntn_signal_strength_info().signal_strength());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nb1_ntn_signal_strength_info()
        ->set_rsrp(strength.nb1_ntn_signal_strength_info().rsrp());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nb1_ntn_signal_strength_info()
        ->set_rsrq(strength.nb1_ntn_signal_strength_info().rsrq());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nb1_ntn_signal_strength_info()
        ->set_rssnr(strength.nb1_ntn_signal_strength_info().rssnr());
    signalStrengthChangeEvent.mutable_signal_strength()
        ->mutable_nb1_ntn_signal_strength_info()
        ->set_rssi(strength.nb1_ntn_signal_strength_info().rssi());
...
telStub::ServiceStateChangeEvent TelUtil::createServiceStateEvent(
 ...
 */
int TelUtil::checkSignalStrengthCriteriaAndNotify(
    ...
    if (error == ErrorCode::SUCCESS) {
        if (data.status == telux::common::Status::SUCCESS) {
            uint16_t hysteresisMs = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthEx"
                                                                         "Info"]["hysteresisMs"]
                                        .asInt();
            LOG(DEBUG, __FUNCTION__, " hysteresis timer : ", static_cast<int>(hysteresisMs));
            // if hysteresis timer is set, skip other criteria check
            if (hysteresisMs > 0) {
                std::string lastNotificationString
                    = data.stateRootObj[TEL_PHONE_MANAGER]["lastNotificationInfo"]["ssNotificationT"
                                                                                   "imeStamp"]
                          .asString();
                ...
                int currentCount = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExI"
                                                                        "nfo"]["configureSignalStre"
                                                                               "ngthExInfoList"]
                                       .size();
                LOG(DEBUG, __FUNCTION__, " current config count is : ", currentCount);
                ...
                for (int j = 0; j < currentCount; j++) {
                    ...
                    if (rat
                            == (data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInf"
                                                                     "o"]["configureSignalStrengthE"
                                                                          "xInfoList"][j]["radioTec"
                                                                                          "h"]
                                    .asInt())
                        && sigMeasType
                               == (data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExI"
                                                                        "nfo"]["configureSignalStre"
                                                                               "ngthExInfoList"][j]
                                                    ["sigMeasType"]
                                                        .asInt())) {
                        ...
                        int ctCount
                            = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExInfo"]
                                               ["configureSignalStrengthExInfoList"][j]["configExTy"
                                                                                        "pe"]
                                                   .size();
                        LOG(DEBUG, __FUNCTION__, " configType+++ count : ", ctCount);
                        for (int ct = 0; ct < ctCount; ct++) {
                            configType
                                = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrengthExIn"
                                                                       "fo"]["configureSignalStreng"
                                                                             "thExInfoList"][j]
                                                   ["configExType"][ct]
                                                       .asInt();
                            ...
                            if (configType
                                ...
                                uint16_t delta = data.stateRootObj[TEL_PHONE_MANAGER]["configureSig"
                                                                                      "nalStrengthE"
                                                                                      "xInfo"]
                                                                  ["configureSignalStrengthExInfoLi"
                                                                   "st"][j]["delta"]
                                                                      .asInt();
                                ...
                                if (diff >= (delta / 10)) {
                                    ...
                                    notify = true;
                                       ...
                                       == static_cast<int>(
                                           telStub::SignalStrengthConfigExType::EX_THRESHOLD)) {
                                int thresholdListLen
                                    = data.stateRootObj[TEL_PHONE_MANAGER]["configureSignalStrength"
                                                                           "ExInfo"]["configureSign"
                                                                                     "alStrengthExI"
                                                                                     "nfoList"][j]
                                                       ["thresholdList"]
                                                           .size();
                                LOG(DEBUG, "  threshold list size :", thresholdListLen);
                                if (thresholdListLen > 0
                                    && thresholdListLen <= MAX_THRESHOLD_LIST) {
                                    ...
                                    for (int thIdx = 0; thIdx < thresholdListLen; thIdx++) {
                                        int threshold
                                            = ((data.stateRootObj[TEL_PHONE_MANAGER]["configureSign"
                                                                                     "alStrengthExI"
                                                                                     "nfo"]
                                                                 ["configureSignalStrengthExInfoLis"
                                                                  "t"][j]["thresholdList"][thIdx]
                                                                     .asInt())
                                                / 10);
