...
static asn_TYPE_member_t asn_MBR_EventPoint_1[] = {
    {ATF_NOFLAGS, 0, offsetof(struct EventPoint, eventPosition), (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
    ...
    {ATF_POINTER, 1, offsetof(struct EventPoint, eventDeltaTime),
        ...
        &asn_DEF_PathDeltaTime, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "eventDeltaTime"},
    {ATF_NOFLAGS, 0, offsetof(struct EventPoint, informationQuality),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_InformationQuality, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "informationQuality"},
};
static const int asn_MAP_EventPoint_oms_1[]            = {1};
static const ber_tlv_tag_t asn_DEF_EventPoint_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
static asn_SEQUENCE_specifics_t asn_SPC_EventPoint_specs_1 = {
    sizeof(struct EventPoint), offsetof(struct EventPoint, _asn_ctx), asn_MAP_EventPoint_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_EventPoint = {
    "EventPoint", "EventPoint", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_EventPoint_tags_1) / sizeof(asn_DEF_EventPoint_tags_1[0]), /* 1 */
    asn_DEF_EventPoint_tags_1, /* Same as above */
    sizeof(asn_DEF_EventPoint_tags_1) / sizeof(asn_DEF_EventPoint_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_EventPoint_1, 3, /* Elements count */
