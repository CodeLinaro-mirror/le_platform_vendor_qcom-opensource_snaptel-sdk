...
static asn_TYPE_member_t asn_MBR_LocationContainer_1[] = {
    ...
    {ATF_POINTER, 1, offsetof(struct LocationContainer, eventPositionHeading),
        ...
        0, /* No PER visible constraints */
        0, "eventPositionHeading"},
    {ATF_NOFLAGS, 0, offsetof(struct LocationContainer, traces), (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
        -1, /* IMPLICIT tag at current level */
        &asn_DEF_Traces, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "traces"},
    {ATF_POINTER, 1, offsetof(struct LocationContainer, roadType),
        (ASN_TAG_CLASS_CONTEXT | (3 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_RoadType, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "roadType"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_LocationContainer_specs_1 = {
    sizeof(struct LocationContainer), offsetof(struct LocationContainer, _asn_ctx),
    asn_MAP_LocationContainer_tag2el_1, 4, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_LocationContainer = {
    "LocationContainer", "LocationContainer", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_LocationContainer_tags_1) / sizeof(asn_DEF_LocationContainer_tags_1[0]), /* 1 */
    asn_DEF_LocationContainer_tags_1, /* Same as above */
    sizeof(asn_DEF_LocationContainer_tags_1) / sizeof(asn_DEF_LocationContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_LocationContainer_1, 4, /* Elements count */
