...
static asn_TYPE_member_t asn_MBR_CenDsrcTollingZone_1[] = {
    ...
    {ATF_POINTER, 1, offsetof(struct CenDsrcTollingZone, cenDsrcTollingZoneID),
        ...
        &asn_DEF_CenDsrcTollingZoneID, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "cenDsrcTollingZoneID"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_CenDsrcTollingZone_specs_1 = {
    sizeof(struct CenDsrcTollingZone), offsetof(struct CenDsrcTollingZone, _asn_ctx),
    asn_MAP_CenDsrcTollingZone_tag2el_1, 3, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_CenDsrcTollingZone = {
    "CenDsrcTollingZone", "CenDsrcTollingZone", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_CenDsrcTollingZone_tags_1)
        / sizeof(asn_DEF_CenDsrcTollingZone_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_CenDsrcTollingZone_1, 3, /* Elements count */
