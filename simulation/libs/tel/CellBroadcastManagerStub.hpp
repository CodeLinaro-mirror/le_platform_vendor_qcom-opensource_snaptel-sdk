...
class CellBroadcastManagerStub : public ICellBroadcastManager,
 ...
 public:
    ...
    telux::common::Status requestMessageFilters(RequestFiltersResponseCallback callback);
    telux::common::Status setActivationStatus(
        bool activate, telux::common::ResponseCallback callback = nullptr);
    telux::common::Status requestActivationStatus(RequestActivationStatusResponseCallback callback);
 ...
 private:
    ...
    void invokeCallback(telux::common::ResponseCallback callback, telux::common::ErrorCode error);
    void invokeCallback(RequestFiltersResponseCallback callback, telux::common::ErrorCode error,
    ...
    void invokeInitResponseCallback(
