...
static asn_TYPE_member_t asn_MBR_RSUContainerHighFrequency_1[] = {
    {ATF_POINTER, 1, offsetof(struct RSUContainerHighFrequency, protectedCommunicationZonesRSU),
        ...
        0, "protectedCommunicationZonesRSU"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_RSUContainerHighFrequency_specs_1 = {
    sizeof(struct RSUContainerHighFrequency), offsetof(struct RSUContainerHighFrequency, _asn_ctx),
    asn_MAP_RSUContainerHighFrequency_tag2el_1, 1, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_RSUContainerHighFrequency = {
    "RSUContainerHighFrequency", "RSUContainerHighFrequency", SEQUENCE_free, SEQUENCE_print,
    ...
    sizeof(asn_DEF_RSUContainerHighFrequency_tags_1)
        / sizeof(asn_DEF_RSUContainerHighFrequency_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_RSUContainerHighFrequency_1, 1, /* Elements count */
