...
telux::common::Status PhoneStub::requestVoiceServiceState(
    ...
    VoiceServiceDenialCause denialCause = static_cast<VoiceServiceDenialCause>(
        response.voice_service_state_info().voice_service_denial_cause());
    RadioTechnology radioTech
        = static_cast<RadioTechnology>(response.voice_service_state_info().radio_technology());
    ...
    if ((status == telux::common::Status::SUCCESS) && (isCallbackNeeded)) {
        auto fut = std::async(std::launch::async, [this, cbDelay, error, callback, vocSrvInfo]() {
...
telux::common::Status PhoneStub::requestCellInfo(telux::tel::CellInfoCallback callback) {
    ...
    for (int i = 0; i < response.cell_info_list_size(); i++) {
        ...
        switch (cellType) {
            case CellType::GSM: {
                string gsmMcc = response.mutable_cell_info_list(i)
                                    ->mutable_gsm_cell_info()
                                    ->mutable_gsm_cell_identity()
                                    ->mcc();
                string gsmMnc = response.mutable_cell_info_list(i)
                                    ->mutable_gsm_cell_info()
                                    ->mutable_gsm_cell_identity()
                                    ->mnc();
                int gsmLac = response.mutable_cell_info_list(i)
                                 ->mutable_gsm_cell_info()
                                 ->mutable_gsm_cell_identity()
                                 ->lac();
                int gsmCid = response.mutable_cell_info_list(i)
                                 ->mutable_gsm_cell_info()
                                 ->mutable_gsm_cell_identity()
                                 ->cid();
                int gsmArfcn = response.mutable_cell_info_list(i)
                                   ->mutable_gsm_cell_info()
                                   ->mutable_gsm_cell_identity()
                                   ->arfcn();
                int gsmBsic = response.mutable_cell_info_list(i)
                                  ->mutable_gsm_cell_info()
                                  ->mutable_gsm_cell_identity()
                                  ->bsic();
            ...
            case CellType::WCDMA: {
                string wcdmaMcc = response.mutable_cell_info_list(i)
                                      ->mutable_wcdma_cell_info()
                                      ->mutable_wcdma_cell_identity()
                                      ->mcc();
                string wcdmaMnc = response.mutable_cell_info_list(i)
                                      ->mutable_wcdma_cell_info()
                                      ->mutable_wcdma_cell_identity()
                                      ->mnc();
                int wcdmaLac = response.mutable_cell_info_list(i)
                                   ->mutable_wcdma_cell_info()
                                   ->mutable_wcdma_cell_identity()
                                   ->lac();
                int wcdmaCid = response.mutable_cell_info_list(i)
                                   ->mutable_wcdma_cell_info()
                                   ->mutable_wcdma_cell_identity()
                                   ->cid();
                int wcdmaArfcn = response.mutable_cell_info_list(i)
                                     ->mutable_wcdma_cell_info()
                                     ->mutable_wcdma_cell_identity()
                                     ->uarfcn();
                int wcdmaPsc = response.mutable_cell_info_list(i)
                                   ->mutable_wcdma_cell_info()
                                   ->mutable_wcdma_cell_identity()
                                   ->psc();
                ...
                int wcdmaRscp = response.mutable_cell_info_list(i)
                                    ...
                                    ->mutable_wcdma_signal_strength_info()
                                    ->rscp();
                int wcdmaRssi = response.mutable_cell_info_list(i)
                                    ->mutable_wcdma_cell_info()
                                    ->mutable_wcdma_signal_strength_info()
                                    ->rssi();
            ...
            case CellType::LTE: {
                string lteMcc = response.mutable_cell_info_list(i)
                                    ->mutable_lte_cell_info()
                                    ->mutable_lte_cell_identity()
                                    ->mcc();
                string lteMnc = response.mutable_cell_info_list(i)
                                    ->mutable_lte_cell_info()
                                    ->mutable_lte_cell_identity()
                                    ->mnc();
                int lteTac = response.mutable_cell_info_list(i)
                                 ->mutable_lte_cell_info()
                                 ->mutable_lte_cell_identity()
                                 ->tac();
                int lteCi = response.mutable_cell_info_list(i)
                                ->mutable_lte_cell_info()
                                ->mutable_lte_cell_identity()
                                ->ci();
                int lteEarfcn = response.mutable_cell_info_list(i)
                                    ->mutable_lte_cell_info()
                                    ->mutable_lte_cell_identity()
                                    ->earfcn();
                int ltePci = response.mutable_cell_info_list(i)
                                 ->mutable_lte_cell_info()
                                 ->mutable_lte_cell_identity()
                                 ->pci();
                int lteSignalStrength = response.mutable_cell_info_list(i)
                                            ...
                                            ->lte_signal_strength();
                int lteRsrp = response.mutable_cell_info_list(i)
                                  ->mutable_lte_cell_info()
                                  ->mutable_lte_signal_strength_info()
                                  ->lte_rsrp();
                int lteRsrq = response.mutable_cell_info_list(i)
                                  ->mutable_lte_cell_info()
                                  ->mutable_lte_signal_strength_info()
                                  ->lte_rsrq();
                int lteRssnr = response.mutable_cell_info_list(i)
                                   ->mutable_lte_cell_info()
                                   ->mutable_lte_signal_strength_info()
                                   ->lte_rssnr();
            ...
            case CellType::NR5G: {
                string nr5gMcc = response.mutable_cell_info_list(i)
                                     ->mutable_nr5g_cell_info()
                                     ->mutable_nr5g_cell_identity()
                                     ->mcc();
                string nr5gMnc = response.mutable_cell_info_list(i)
                                     ->mutable_nr5g_cell_info()
                                     ->mutable_nr5g_cell_identity()
                                     ->mnc();
                int nr5gTac = response.mutable_cell_info_list(i)
                                  ->mutable_nr5g_cell_info()
                                  ->mutable_nr5g_cell_identity()
                                  ->tac();
                int nr5gCi = response.mutable_cell_info_list(i)
                                 ->mutable_nr5g_cell_info()
                                 ->mutable_nr5g_cell_identity()
                                 ->ci();
                int nr5gArfcn = response.mutable_cell_info_list(i)
                                    ->mutable_nr5g_cell_info()
                                    ->mutable_nr5g_cell_identity()
                                    ->arfcn();
                int nr5gPci = response.mutable_cell_info_list(i)
                                  ->mutable_nr5g_cell_info()
                                  ->mutable_nr5g_cell_identity()
                                  ->pci();
                int nr5gRsrp = response.mutable_cell_info_list(i)
                                   ->mutable_nr5g_cell_info()
                                   ->mutable_nr5g_signal_strength_info()
                                   ->rsrp();
                int nr5gRsrq = response.mutable_cell_info_list(i)
                                   ->mutable_nr5g_cell_info()
                                   ->mutable_nr5g_signal_strength_info()
                                   ->rsrq();
                int nr5gRssnr = response.mutable_cell_info_list(i)
                                    ->mutable_nr5g_cell_info()
                                    ->mutable_nr5g_signal_strength_info()
                                    ->rssnr();
            ...
            case CellType::NB1_NTN: {
                string nb1NtnMcc = response.mutable_cell_info_list(i)
                                       ->mutable_nb1_ntn_cell_info()
                                       ->mutable_nb1_ntn_cell_identity()
                                       ->mcc();
                string nb1NtnMnc = response.mutable_cell_info_list(i)
                                       ->mutable_nb1_ntn_cell_info()
                                       ->mutable_nb1_ntn_cell_identity()
                                       ->mnc();
                int nb1NtnTac = response.mutable_cell_info_list(i)
                                    ->mutable_nb1_ntn_cell_info()
                                    ->mutable_nb1_ntn_cell_identity()
                                    ->tac();
                int nb1NtnCi = response.mutable_cell_info_list(i)
                                   ->mutable_nb1_ntn_cell_info()
                                   ->mutable_nb1_ntn_cell_identity()
                                   ->ci();
                int nb1NtnEarfcn = response.mutable_cell_info_list(i)
                                       ->mutable_nb1_ntn_cell_info()
                                       ->mutable_nb1_ntn_cell_identity()
                                       ->earfcn();
                int nb1NtnSignalStrength = response.mutable_cell_info_list(i)
                                               ...
                                               ->signal_strength();
                int nb1NtnRsrp = response.mutable_cell_info_list(i)
                                     ->mutable_nb1_ntn_cell_info()
                                     ->mutable_nb1_ntn_signal_strength_info()
                                     ->rsrp();
                int nb1NtnRsrq = response.mutable_cell_info_list(i)
                                     ->mutable_nb1_ntn_cell_info()
                                     ->mutable_nb1_ntn_signal_strength_info()
                                     ->rsrq();
                int nb1NtnRssnr = response.mutable_cell_info_list(i)
                                      ->mutable_nb1_ntn_cell_info()
                                      ->mutable_nb1_ntn_signal_strength_info()
                                      ->rssnr();
                int nb1NtnRssi = response.mutable_cell_info_list(i)
                                     ->mutable_nb1_ntn_cell_info()
                                     ->mutable_nb1_ntn_signal_strength_info()
                                     ->rssi();
    ...
    int cbDelay                    = static_cast<int>(response.delay());
    if ((status == telux::common::Status::SUCCESS) && (isCallbackNeeded)) {
        auto fut = std::async(std::launch::async, [this, cbDelay, error, callback, cellInfoList]() {
            std::this_thread::sleep_for(std::chrono::milliseconds(cbDelay));
            if (callback) {
...
telux::common::Status PhoneStub::setCellInfoListRate(
    uint32_t timeInterval, common::ResponseCallback callback) {
    LOG(DEBUG, __FUNCTION__);
...
telux::common::Status PhoneStub::requestSignalStrength(
    ...
    std::shared_ptr<Nb1NtnSignalStrengthInfo> nb1NtnSignalStrength
        = std::make_shared<Nb1NtnSignalStrengthInfo>(response.mutable_signal_strength()
                                                         ->mutable_nb1_ntn_signal_strength_info()
                                                         ->signal_strength(),
    ...
    if ((status == telux::common::Status::SUCCESS) && (isCallbackNeeded)) {
        auto fut = std::async(
            std::launch::async, [this, cbDelay, error, callback, signalStrengthNotify]() {
                std::this_thread::sleep_for(std::chrono::milliseconds(cbDelay));
                if (callback) {
...
telux::common::Status PhoneStub::setECallOperatingMode(
...
telux::common::Status PhoneStub::requestECallOperatingMode(ECallGetOperatingModeCallback callback) {
    ...
    int cbDelay                    = static_cast<int>(response.delay());
    if ((status == telux::common::Status::SUCCESS) && (isCallbackNeeded)) {
        auto fut = std::async(std::launch::async, [this, cbDelay, error, callback, eCallMode]() {
            std::this_thread::sleep_for(std::chrono::milliseconds(cbDelay));
            if (callback) {
...
telux::common::Status PhoneStub::requestOperatorInfo(OperatorInfoCallback callback) {
    ...
    int cbDelay           = static_cast<int>(response.delay());
    if ((status == telux::common::Status::SUCCESS) && (isCallbackNeeded)) {
        auto fut = std::async(std::launch::async, [this, cbDelay, error, callback, plmnInfo]() {
            std::this_thread::sleep_for(std::chrono::milliseconds(cbDelay));
            if (callback) {
...
telux::common::Status PhoneStub::configureSignalStrength(
    ...
    for (size_t i = 0; i < signalStrengthConfig.size(); i++) {
        ...
        sigConfig->set_config_type(
            static_cast<telStub::SignalStrengthConfigType>(signalStrengthConfig[i].configType));
        sigConfig->set_rat_sig_type(
            static_cast<telStub::RadioSignalStrengthType>(signalStrengthConfig[i].ratSigType));
...
telux::common::Status PhoneStub::configureSignalStrength(
    ...
    for (auto elem : signalStrengthConfigEx) {
        ...
        sigConfigEx->set_radio_tech(static_cast<telStub::RadioTechnology>(elem.radioTech));
        ...
        for (int idx = 0; idx < static_cast<int>(elem.sigConfigData.size()); idx++) {
            ...
            sigConfigData->set_sig_meas_type(static_cast<telStub::SignalStrengthMeasurementType>(
                elem.sigConfigData[idx].sigMeasType));
            if (elem.configTypeMask[static_cast<int>(SignalStrengthConfigExType::DELTA)]) {
                sigConfigData->set_delta(elem.sigConfigData[idx].delta);
            }
            if (elem.configTypeMask[static_cast<int>(SignalStrengthConfigExType::THRESHOLD)]) {
                for (int arrIdx = 0;
                     arrIdx < static_cast<int>(elem.sigConfigData[idx].thresholdList.size());
                     arrIdx++) {
                    if (elem.sigConfigData[idx].thresholdList[arrIdx]) {
                        sigConfigData->mutable_elements()->add_threshold_list(
                            elem.sigConfigData[idx].thresholdList[arrIdx]);
                    }
                }
            }
            if (elem.configTypeMask[static_cast<int>(SignalStrengthConfigExType::HYSTERESIS_DB)]) {
