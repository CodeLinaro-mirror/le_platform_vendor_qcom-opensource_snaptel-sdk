...
class FsManagerServerImpl final : public platformStub::FsManagerService::Service,
 ...
 public:
    ...
    grpc::Status ECallCompleted(ServerContext *context, const google::protobuf::Empty *request,
        platformStub::DefaultReply *response);
    grpc::Status PrepareForOta(ServerContext *context, const ::platformStub::FsEventName *request,
        platformStub::DefaultReply *response);
    grpc::Status OtaCompleted(ServerContext *context, const google::protobuf::Empty *request,
        platformStub::DefaultReply *response);
