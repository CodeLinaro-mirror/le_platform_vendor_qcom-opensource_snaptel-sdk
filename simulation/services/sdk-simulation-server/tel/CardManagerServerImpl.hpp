...
class CardManagerServerImpl final : public telStub::CardService::Service,
 ...
 public:
    ...
    grpc::Status requestEid(ServerContext *context, const ::telStub::requestEidRequest *request,
    ...
    grpc::Status QueryPin1Lock(ServerContext *context, const telStub::QueryPin1LockRequest *request,
        telStub::QueryPin1LockReply *response) override;
    grpc::Status ChangePinLock(ServerContext *context, const telStub::ChangePinLockRequest *request,
    ...
    template <typename T>
    commonStub::ErrorCode findmatchingrecordADF(Json::Value rootObj, T response, int &size,
        int &index, int &recordNum, uint16_t &fileId, int &i) {
 ...
 private:
    ...
    commonStub::ErrorCode findmatchingrecordDF(
        Json::Value rootObj, int &size, int &recordNum, uint16_t &fileId, int &i);
    commonStub::ErrorCode getTransparentFileAttributes(Json::Value rootObj, int &i, uint16_t fileId,
        telux::tel::FileAttributes &attributes, int &index);
    commonStub::ErrorCode getLinearfixedFileAttributes(Json::Value rootObj, int &i, uint16_t fileId,
        telux::tel::FileAttributes &attributes, int &index);
    ...
    bool clientSimRefreshInfoPresent(
