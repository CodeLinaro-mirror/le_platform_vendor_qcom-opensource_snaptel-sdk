...
static asn_TYPE_member_t asn_MBR_AlacarteContainer_1[] = {
    ...
    {ATF_POINTER, 5, offsetof(struct AlacarteContainer, impactReduction),
        ...
        &asn_DEF_ImpactReductionContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "impactReduction"},
    {ATF_POINTER, 4, offsetof(struct AlacarteContainer, externalTemperature),
        (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_Temperature, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "externalTemperature"},
    {ATF_POINTER, 3, offsetof(struct AlacarteContainer, roadWorks),
        (ASN_TAG_CLASS_CONTEXT | (3 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_RoadWorksContainerExtended, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "roadWorks"},
    {ATF_POINTER, 2, offsetof(struct AlacarteContainer, positioningSolution),
        ...
        &asn_DEF_PositioningSolutionType, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "positioningSolution"},
    {ATF_POINTER, 1, offsetof(struct AlacarteContainer, stationaryVehicle),
        ...
        &asn_DEF_StationaryVehicleContainer, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "stationaryVehicle"},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_AlacarteContainer_specs_1 = {
    sizeof(struct AlacarteContainer), offsetof(struct AlacarteContainer, _asn_ctx),
    asn_MAP_AlacarteContainer_tag2el_1, 6, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_AlacarteContainer = {
    "AlacarteContainer", "AlacarteContainer", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_AlacarteContainer_tags_1) / sizeof(asn_DEF_AlacarteContainer_tags_1[0]), /* 1 */
    asn_DEF_AlacarteContainer_tags_1, /* Same as above */
    sizeof(asn_DEF_AlacarteContainer_tags_1) / sizeof(asn_DEF_AlacarteContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_AlacarteContainer_1, 6, /* Elements count */
