...
class ICryptoManager {
 ...
 public:
     ...
     *
     */
    virtual telux::common::ErrorCode importKey(std::shared_ptr<ICryptoParam> cryptoParam,
     ...
     *
     */
    virtual telux::common::ErrorCode exportKey(telux::sec::KeyFormat keyFmt,
     ...
     *
     */
    virtual telux::common::ErrorCode upgradeKey(std::shared_ptr<ICryptoParam> cryptoParam,
     ...
     *
     */
    virtual telux::common::ErrorCode signData(std::shared_ptr<ICryptoParam> cryptoParam,
     ...
     *
     */
    virtual telux::common::ErrorCode verifyData(std::shared_ptr<ICryptoParam> cryptoParam,
        std::vector<uint8_t> const &keyBlob, std::vector<uint8_t> const &plainText,
     ...
     *
     */
    virtual telux::common::ErrorCode encryptData(std::shared_ptr<ICryptoParam> cryptoParam,
        std::vector<uint8_t> const &keyBlob, std::vector<uint8_t> const &plainText,
     ...
     *
     */
    virtual telux::common::ErrorCode decryptData(std::shared_ptr<ICryptoParam> cryptoParam,
