...
static asn_TYPE_member_t asn_MBR_ClosedLanes_1[] = {
    {ATF_POINTER, 1, offsetof(struct ClosedLanes, hardShoulderStatus),
        ...
        &asn_DEF_HardShoulderStatus, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "hardShoulderStatus"},
    {ATF_NOFLAGS, 0, offsetof(struct ClosedLanes, drivingLaneStatus),
        (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
        &asn_DEF_DrivingLaneStatus, 0, /* Defer constraints checking to the member type */
        0, /* No PER visible constraints */
        0, "drivingLaneStatus"},
};
static const int asn_MAP_ClosedLanes_oms_1[]            = {0};
static const ber_tlv_tag_t asn_DEF_ClosedLanes_tags_1[] = {(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))};
...
static asn_SEQUENCE_specifics_t asn_SPC_ClosedLanes_specs_1 = {
    sizeof(struct ClosedLanes), offsetof(struct ClosedLanes, _asn_ctx),
    asn_MAP_ClosedLanes_tag2el_1, 2, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_ClosedLanes = {
    "ClosedLanes", "ClosedLanes", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_ClosedLanes_tags_1) / sizeof(asn_DEF_ClosedLanes_tags_1[0]), /* 1 */
    asn_DEF_ClosedLanes_tags_1, /* Same as above */
    sizeof(asn_DEF_ClosedLanes_tags_1) / sizeof(asn_DEF_ClosedLanes_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_ClosedLanes_1, 2, /* Elements count */
