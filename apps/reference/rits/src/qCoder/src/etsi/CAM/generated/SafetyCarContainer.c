...
static asn_SEQUENCE_specifics_t asn_SPC_SafetyCarContainer_specs_1 = {
    sizeof(struct SafetyCarContainer), offsetof(struct SafetyCarContainer, _asn_ctx),
    asn_MAP_SafetyCarContainer_tag2el_1, 4, /* Count of tags in the map */
...
asn_TYPE_descriptor_t asn_DEF_SafetyCarContainer = {
    "SafetyCarContainer", "SafetyCarContainer", SEQUENCE_free, SEQUENCE_print, SEQUENCE_constraint,
    ...
    sizeof(asn_DEF_SafetyCarContainer_tags_1)
        / sizeof(asn_DEF_SafetyCarContainer_tags_1[0]), /* 1 */
    0, /* No PER visible constraints */
    asn_MBR_SafetyCarContainer_1, 4, /* Elements count */
